...
METHOD Create()
   ...
   ::AddField ( "nDifUnd", "N", 13, 6, {|| MasUnd() },        "Diferencia",    .t., "Diferencia unidades",  12 )
      ...
      while !::lBreak .and. !::oDbfArt:Eof()
         ...
         if ( !::lMinCero .or. ::oDbfArt:nMinimo != 0 )
            ...
            if ( ::nEstado == 1 .or. nStockActual < ::oDbfArt:nMinimo )
               ...
               ::oDbf:nDifUnd := ( ::oDbf:nNumUnd - ::oDbf:nUndMin )
               ::oDbf:Save()
