...
METHOD OpenFiles() CLASS TRenRAlb
...
METHOD CloseFiles() CLASS TRenRAlb
...
METHOD lResource( cFld ) CLASS TRenRAlb

   local cEstado := "Todos"

   if !::StdResource( "INFRENART" )
      return .f.
   end if
...
METHOD lGenerate() CLASS TRenRAlb
