...
METHOD OpenFiles() CLASS TInfRTik
...
METHOD CloseFiles() CLASS TInfRTik
...
METHOD lResource( cFld ) CLASS TInfRTik

   if !::StdResource( "INFDETART_B" )
      return .f.
   end if
