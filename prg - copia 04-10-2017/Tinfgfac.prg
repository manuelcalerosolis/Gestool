...
METHOD Create()
   ...
   ::AddGroup( {|| ::oDbf:cGrpFam + ::oDbf:cCodArt }, {|| "Artículo : " + Rtrim( ::oDbf:cCodArt ) + "-" + Rtrim( oRetFld( ::oDbf:cCodArt, ::oDbfArt ) ) }, {||"Total articulo..."} )

RETURN ( self )

//---------------------------------------------------------------------------//

METHOD OpenFiles() CLASS TInfGFac
...
METHOD CloseFiles() CLASS TInfGFac
...
METHOD lResource( cFld ) CLASS TInfGFac
...
METHOD lGenerate() CLASS TInfGFac
