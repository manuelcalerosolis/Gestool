...
METHOD OpenFiles() CLASS TAcuFFac
...
METHOD CloseFiles() CLASS TAcuFFac
...
METHOD lResource( cFld ) CLASS TAcuFFac
...
METHOD lGenerate() CLASS TAcuFFac
   ...
   ::oFacCliL:AddTmpIndex( cCurUsr(), GetFileNoExt( ::oFacCliL:cFile ), ::oFacCliL:OrdKey(), ( cExpLine ), , , , , , , , .t. )
