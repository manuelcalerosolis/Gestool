...
METHOD OpenFiles() CLASS TRenNVta
...
METHOD CloseFiles() CLASS TRenNVta
...
METHOD lResource( cFld ) CLASS TRenNVta

   if !::StdResource( "INFRENAGER" )
      return .f.
   end if
