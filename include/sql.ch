...
#define LOCK_RECORD_EXCLUSIVE     1
#define LOCK_RECORD_MULTIPLE      2
...
/* Option Isolation */
#define TXN_READ_UNCOMMITTED             1
#define TXN_READ_COMMITTED               2
#define TXN_REPEATABLE_READ              4
#define TXN_SERIALIZABLE                 8

#ifndef __HARBOUR__
   #define FIELD_MAXLENGTH    1024*32
#else
   #define FIELD_MAXLENGTH    1024*128
#endif