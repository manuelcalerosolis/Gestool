...
function aColRctPrv()
   ...
   aAdd( aColFacPrv, { "CVALPR1"    ,"C", 40, 0, "Valor de la propiedad 1" ,     "",                    "", "( cDbfCol )" } )
   aAdd( aColFacPrv, { "CVALPR2"    ,"C", 40, 0, "Valor de la propiedad 2" ,     "",                    "", "( cDbfCol )" } )
...
Function aLblRctPrv()
   ...
   aAdd( aLblFacPrv, { "CVALPR1"    ,"C", 40, 0, "Valor de la propiedad 1" ,    "",                    "", "( cDbfCol )" } )
   aAdd( aLblFacPrv, { "CVALPR2"    ,"C", 40, 0, "Valor de la propiedad 2" ,    "",                    "", "( cDbfCol )" } )
