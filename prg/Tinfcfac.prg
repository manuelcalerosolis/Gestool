...
METHOD OpenFiles() CLASS TInfCFac
...
METHOD CloseFiles() CLASS TInfCFac
...
METHOD lResource( cFld ) CLASS TInfCFac

   local cEstado := "Todas"
   local oIncEsc

   if !::StdResource( "INF_GEN31" )
      return .f.
   end if
...
METHOD lGenerate() CLASS TInfCFac
