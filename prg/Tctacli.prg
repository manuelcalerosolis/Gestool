...
METHOD Create()
   ...
   ::AddField ( "CCODCLI", "C", 12, 0, {|| "@!" },         "Código",                  .f., "Código cliente"          ,  8 )
   ::AddField ( "CNOMCLI", "C", 50, 0, {|| "@!" },         "Cliente",                 .f., "Nombre cliente"          , 25 )
   ::AddField ( "CDOCMOV", "C", 40, 0, {|| "@!" },         "Documento",               .t., "Documento"               , 40 )
   ::AddField ( "DFECMOV", "D",  8, 0, {|| "@!" },         "Fecha",                   .t., "Fecha"                   , 12 )
   ...
   ::AddField ( "NTOTDEB", "N", 16, 3, {|| ::cPicOut },    "Facturado",               .t., "Facturado"               , 12 )
   ::AddField ( "NTOTHAB", "N", 16, 3, {|| ::cPicOut },    "Cobrado",                 .t., "Cobrado"                 , 12 )
   ::AddField ( "NTOTSAL", "N", 16, 3, {|| ::cPicOut },    "Saldo",                   .t., "Saldo"                   , 12 )
