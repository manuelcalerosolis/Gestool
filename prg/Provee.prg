...
Method ReciveData()
   ...
   */
   ...
   for n := 1 to len( aExt )
      FtpGetFiles( "Prv*." + aExt[ n ], cPatIn(), 2000, ::oSender )
   next
...
FUNCTION aItmPrv()
   ...
   aAdd( aItmPrv, { "DOMICILIO", "C",100, 0, "Domicilio proveedor",                  "",                   "", "( cDbfPrv )" } )
   aAdd( aItmPrv, { "POBLACION", "C", 25, 0, "Población proveedor",                  "",                   "", "( cDbfPrv )" } )
   aAdd( aItmPrv, { "PROVINCIA", "C", 20, 0, "Provincia proveedor",                  "",                   "", "( cDbfPrv )" } )
   ...
   aAdd( aItmPrv, { "TELEFONO",  "C", 12, 0, "Teléfono proveedor",                   "",                   "", "( cDbfPrv )" } )
   aAdd( aItmPrv, { "FAX",       "C", 12, 0, "Fax proveedor",                        "",                   "", "( cDbfPrv )" } )
   aAdd( aItmPrv, { "MOVIL",     "C", 12, 0, "Movil proveedor",                      "",                   "", "( cDbfPrv )" } )
   ...
   if oLabel:lCreateTemporal()
      ...
      */
      ...
      if !Empty( ( dbfDoc )->mReport )
         ...
         oFr:SetObjProperty(  "CabeceraColumnas",  "DataSet",        "Proveedores" )
