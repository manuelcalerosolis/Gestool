...
METHOD OpenFiles() CLASS TAcuCAlb
...
METHOD CloseFiles() CLASS TAcuCAlb
...
METHOD lResource( cFld ) CLASS TAcuCAlb

   local cEstado := "Todos"

   if !::StdResource( "INFACUCLIB" )
      return .f.
   end if
...
METHOD lGenerate() CLASS TAcuCAlb
