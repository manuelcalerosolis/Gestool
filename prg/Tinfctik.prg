...
METHOD OpenFiles() CLASS TInfCTik
...
METHOD CloseFiles() CLASS TInfCTik
...
METHOD lResource( cFld ) CLASS TInfCTik

   if !::StdResource( "INF_GEN11G" )
      return .f.
   end if
...
METHOD lGenerate() CLASS TInfCTik
