...
METHOD Create()
   ...
   ::AddField ( "nTotDeb", "N", 16, 3, {|| ::cPicIn },  "Facturado",               .t., "Total facturado"         , 12 )
   ::AddField ( "nTotHab", "N", 16, 3, {|| ::cPicIn },  "Pagado",                  .t., "Total pagado"            , 12 )
   ::AddField ( "nTotSal", "N", 16, 3, {|| ::cPicIn },  "Saldo",                   .t., "Saldo"                   , 12 )
