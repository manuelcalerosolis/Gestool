...
METHOD OpenFiles() CLASS TRenGFac
...
METHod lResource( cFld ) CLASS TRenGFac
...
METHOD lGenerate() CLASS TRenGFac
   ...
   ::oMtrInf:AutoInc( ::oFacCliL:Recno() )
   ...
   /*
   Empezamos las facturas rectificativas
   */
