...
CLASS TInfStockMinimoGrupo FROM TInfGen
...
METHOD Create()
   ...
   ::AddTmpIndex( "cCodAlm", "cCodAlm + cCodGrp + cCodFam + cCodArt" )

   ::AddGroup( {|| ::oDbf:cCodAlm }, {|| "Almacén  : " + Rtrim( ::oDbf:cCodAlm ) + "-" + oRetFld( ::oDbf:cCodAlm, ::oDbfAlm ) }, {|| "Total almacén..." } )
   ::AddGroup( {|| ::oDbf:cCodAlm + ::oDbf:cCodGrp }, {|| "Grp. fam. : " + Rtrim( ::oDbf:cCodGrp ) + "-" + oRetFld( ::oDbf:cCodGrp, ::oGruFam:oDbf ) }, {|| "Total grupo família..." } )
...
METHOD lGenerate()
   ...
   ::aHeader   := {  {|| "Fecha     : " + Dtoc( Date() ) },;
                     ...
                     {|| "Grp. fam. : " + if( ::lAllGrp, "Todas", AllTrim( ::cGruFamOrg ) + " > " + AllTrim( ::cGruFamDes ) ) },;
