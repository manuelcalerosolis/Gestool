...
CLASS PedidosComprasController FROM OperacionesComercialesController
   ...
   METHOD getSubject()                 INLINE ( "Pedido de compras número" )

   // Contrucciones tardias----------------------------------------------------

   METHOD getName()                    INLINE ( "pedidos_compra" )

   METHOD getModel()                   INLINE ( if( empty( ::oModel ), ::oModel := SQLPedidosComprasModel():New( self ), ), ::oModel )

   METHOD getValidator()               INLINE ( if( empty( ::oValidator ), ::oValidator := PedidosCompraValidator():New( self ), ), ::oValidator ) 

   METHOD getBrowseView()              INLINE ( if( empty( ::oBrowseView ), ::oBrowseView := PedidosComprasBrowseView():New( self ), ), ::oBrowseView )

   METHOD getRepository()              INLINE ( if( empty( ::oRepository ), ::oRepository := PedidosComprasRepository():New( self ), ), ::oRepository )
...
METHOD New( oController ) CLASS PedidosComprasController

   ::Super:New( oController )

   ::cTitle                            := "Pedidos de compras"
...
METHOD End() CLASS PedidosComprasController
...
CLASS PedidosCompraValidator FROM OperacionesComercialesValidator 
...
METHOD New( oController ) CLASS PedidosCompraValidator

RETURN ( ::Super:New( oController ) )

//---------------------------------------------------------------------------//

METHOD getValidators() CLASS PedidosCompraValidator
