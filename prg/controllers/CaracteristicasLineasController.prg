...
METHOD testCreateLineaSinPadre() CLASS TestCaracteristicasLineasController
   ...
   ::getAssert():notEquals( SQLCaracteristicasLineasModel():test_create_sin_parent(), 1, "test create linea" )
...
METHOD testCreateLineaConPadre() CLASS TestCaracteristicasLineasController
   ...
   ::getAssert():notEquals( SQLCaracteristicasModel():test_create_caracteristica( uuidParent ), 0, "test create caracteristica" )

   ::getAssert():notEquals( SQLCaracteristicasLineasModel():test_create_con_parent( uuidParent ), 0, "test create linea" )
...
METHOD testCreateLineaSinNombre() CLASS TestCaracteristicasLineasController
   ...
   ::getAssert():notEquals( SQLCaracteristicasLineasModel():test_create_sin_nombre( uuidParent ), 1, "test create linea" )
