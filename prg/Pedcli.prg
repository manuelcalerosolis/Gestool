...
function aItmPedCli()
   ...
   aAdd( aItmPedCli, { "CDIRCLI", "C",  200,  0, "Domicilio del cliente",                                   "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "CPOBCLI", "C",  200,  0, "Población del cliente",                                   "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "CPRVCLI", "C",  100,  0, "Provincia del cliente",                                   "",   "", "( cDbf )", nil } )
   ...
   aAdd( aItmPedCli, { "NDTOESP", "N",    5,  2, "Porcentaje de descuento",                                 "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "CDPP",    "C",   50,  0, "Descripción porcentaje de descuento por pronto pago",     "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "NDPP",    "N",    5,  2, "Pct. de dto. por pronto pago",                            "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "CDTOUNO", "C",   25,  0, "Desc. del primer descuento pers.",                        "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "NDTOUNO", "N",    5,  2, "Pct. del primer descuento pers.",                         "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "CDTODOS", "C",   25,  0, "Desc. del segundo descuento pers.",                       "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "NDTODOS", "N",    5,  2, "Pct. del segundo descuento pers.",                        "",   "", "( cDbf )", nil } )
   ...
   aAdd( aItmPedCli, { "NBULTOS", "N",    3,  0, "Número de bultos",                                        "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "CNUMPRE", "C",   12,  0, "",                                                        "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "CDIVPED", "C",    3,  0, "Código de divisa",                                        "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "NVDVPED", "N",   10,  4, "Valor del cambio de la divisa",                           "",   "", "( cDbf )", nil } )
   ...
   aAdd( aItmPedCli, { "NIVAMAN", "N",    6,  2, "Porcentaje de " + cImp() + " del gasto" ,                 "",   "", "( cDbf )", nil } )
   aAdd( aItmPedCli, { "NMANOBR", "N",   16,  6, "Gastos" ,                                                 "",   "", "( cDbf )", nil } )
   ...
   aAdd( aItmPedCli, { "NMONTAJE","N",    6 , 2, "Horas de montaje",                                        "",   "", "( cDbf )", nil } )
   ...
   aAdd( aItmPedCli, { "nDtoTarifa","N",  6,  2, "Descuentos de tarifa", 			                           "", 	"", "( cDbf )", nil } )
...
function Prueba()
   ...
   local hashTable
   local hashDictionary
   
   hashTable         := hashPedidoClientesCabecera()

   hashDictionary    := readHashDictionary( hashPedidoClientesCabecera(), D():PedidosClientes( nView ) )

   
   msginfo( ValType( hashDictionary ), Len( hashDictionary ) )
   MsgInfo( ValtoPrg( hashDictionary ), Len( hashDictionary ) )
