   ...
   if Empty( oWndBrw )
      ...
      */
      ...
      DEFINE BTNSHELL RESOURCE "Mail" OF oWndBrw ;
         NOBORDER ;
         ACTION   ( TGenMailing():ClientResource( ( D():Get( "Client", nView ) ), aItmCli(), oWndBrw ) ) ;
...
FUNCTION aItmCli()
   ...
   aAdd( aBase, { "Domicilio", "C",200, 0, "Domicilio",                                     "",                   "", "( cDbfCli )" } )
   aAdd( aBase, { "Poblacion", "C",200, 0, "Población",                                     "",                   "", "( cDbfCli )" } )
   aAdd( aBase, { "Provincia", "C",100, 0, "Provincia",                                     "",                   "", "( cDbfCli )" } )
