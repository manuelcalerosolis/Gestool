...
CLASS PAnuDiaOperarios FROM TNewInfGen
...
METHOD Create()
   ...
   ::cPrefijoIndice  := "cCodTra"

RETURN ( self )

//---------------------------------------------------------------------------//

METHOD OpenFiles() CLASS PAnuDiaOperarios
...
METHOD CloseFiles() CLASS PAnuDiaOperarios
...
METHOD lResource( cFld ) CLASS PAnuDiaOperarios
...
METHOD lGenerate() CLASS PAnuDiaOperarios
      ...
      if lChkSer( ::oProduccT:oDbf:cSerOrd, ::aSer )
         ...
         if ::oProduccT:oDetPersonal:oDbf:Seek( ::oProduccT:oDbf:cSerOrd + Str( ::oProduccT:oDbf:nNumOrd ) + ::oProduccT:oDbf:cSufOrd )
            ...
            while ::oProduccT:oDetPersonal:oDbf:cSerOrd + Str( ::oProduccT:oDetPersonal:oDbf:nNumOrd ) + ::oProduccT:oDetPersonal:oDbf:cSufOrd == ::oProduccT:oDbf:cSerOrd + Str( ::oProduccT:oDbf:nNumOrd ) + ::oProduccT:oDbf:cSufOrd .and. !::oProduccT:oDetPersonal:oDbf:eof()
               ...
               ::SetValorGrupo( "Operación", ::oProduccT:oDetPersonal:oDbf:cCodOpe )
               ::SetValorGrupo( "Sección", ::oProduccT:oDetPersonal:oDbf:cCodSec )
               ...
               if ( ::oGrupoTOperacion:Cargo:Todos .or.;
                  ...
                  if !::lSeekInAcumulado( ::oProduccT:oDetPersonal:oDbf:cCodTra )
                  ...
                  ::AddImporte( ::oProduccT:oDbf:dFecOrd, ::oProduccT:nTotalOperario( ::oProduccT:oDbf:cSerOrd + Str( ::oProduccT:oDbf:nNumOrd ) + ::oProduccT:oDbf:cSufOrd + ::oProduccT:oDetPersonal:oDbf:cCodTra ) )
