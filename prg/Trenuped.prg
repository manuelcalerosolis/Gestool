...
METHOD OpenFiles() CLASS TRenUPed
...
METHOD CloseFiles() CLASS TRenUPed
...
METHod lResource( cFld ) CLASS TRenUPed

   local cEstado := "Todos"

   if !::StdResource( "INFRENRUTB" )
      return .f.
   end if
...
METHOD lGenerate() CLASS TRenUPed
