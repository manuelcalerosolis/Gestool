/* ImportaciÛn de datos de factucont */
...
METHOD OpenFiles()
   ...
   if Empty( ::cPathFac )
      MsgStop( "Ruta de factucont ¬Æ est√° vac√≠a" )
      return .f.
   end if
...
METHOD Resource()
   ...
   DEFINE DIALOG ::oDlg RESOURCE "IMPFACCOM" TITLE "ImportaciÛn desde factucont Æ" OF oWnd()
      ...
      REDEFINE BUTTON ID 998        OF ::oDlg ACTION ( msginfo( "Ayuda no definida", "InformaciÛn" ) )

   ::oDlg:AddFastKey( VK_F1, {|| msginfo( "Ayuda no definida", "InformaciÛn" ) } )
...
/*
      ...
      //Traspaso de artÌculos

      if ::aLgcIndices[ 3 ]

         //Lo primero es meter las familias, ya que hay que crearles el cÛdigo
         ...
         //Empezamos el trasbase de artÌculos
...
/*
      ...
      msgInfo( "Traspaso realizado con Èxito.", "Bienvenido a " + __GSTROTOR__ + Space( 1 ) + __GSTVERSION__ )
...
METHOD ImportaReciboClientes()
   ...
   while !( ::oDbfFacTFac:eof() )
      ...
      ::oDbfFacPGst:cDesCriP     := "Recibo n∫ 1 de factura " + cSerie  + "/" + Alltrim( Str( nNumero ) ) + "/" + ::oDbfFacPGst:cSufFac 
