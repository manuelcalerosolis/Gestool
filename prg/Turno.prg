...
METHOD Activate()
   ...
   DEFINE BTNSHELL RESOURCE "EDIT" OF ::oWndBrw ;
      NOBORDER ;
      ACTION   ( ::oWndBrw:SetOnProcess(), if( ::oDbf:nStaTur != cajCerrrada, ::lArqueoTurno( .t. ), MsgStop( "Sesión no cerrada." ) ), ::oWndBrw:QuitOnProcess(), ::oWndBrw:SetFocus() );
      TOOLTIP  "(Z)oom";
      HOTKEY   "Z";
      LEVEL    ACC_EDIT
   ...
   ::oWndBrw:bEdit      := {|| ( if( ::oDbf:nStaTur != cajCerrrada, ::lArqueoTurno( .t. ), MsgStop( "Sesión no cerrada." ) ), .t. ) }
