...
CLASS TAcuXFacRec FROM TInfGCli
...
METHOD OpenFiles() CLASS TAcuXFacRec
...
METHOD CloseFiles() CLASS TAcuXFacRec
...
METHOD lResource( cFld ) CLASS TAcuXFacRec
...
METHOD lGenerate() CLASS TAcuXFacRec
