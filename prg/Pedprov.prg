...
function aColPedPrv()
   ...
   aAdd( aColPedPrv,  { "cRefPrv",   "C", 18,   0, "Referencia del proveedor",         "",                           "", "(cDbfCol)", nil } )
   ...
   aAdd( aColPedPrv,  { "nPreDiv",   "N", 16,   6, "Precio",                           "",        "", "(cDbfCol)", nil } )
   ...
   aAdd( aColPedPrv,  { "nDtoLin",   "N",  6,   2, "Descuento en lineas",              "",       "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nDtoPrm",   "N",  6,   2, "Descuento pormociones",            "",       "", "(cDbfCol)", nil } )
   ...
   aAdd( aColPedPrv,  { "cValPr1",   "C", 40,   0, "Valor de la primera propiedad",    "ValorPropiedad1",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "cValPr2",   "C", 40,   0, "Valor de la segunda propiedad",    "ValorPropiedad2",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nFacCnv",   "N", 13,   4, "",                                 "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nCtlStk",   "N",  1,   0, "Control de stock (1,2,3)",         "",                     "", "(cDbfCol)", nil } )
   ...
   aAdd( aColPedPrv,  { "nNumLin",   "N",  4,   0, "Número de la línea",               "",            "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nUndKit",   "N", 16,   6, "Unidades del producto kit",        "",          "", "(cDbfCol)", nil } )
   ...
   aAdd( aColPedPrv,  { "lImpLin",   "L",  1,   0, "Imprimir linea",                   "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "lControl",  "L",  1,   0, "" ,                                "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "mNumSer",   "M", 10,   0, "" ,                                "",                  "", "(cDbfCol)", nil } )
   ...
   aAdd( aColPedPrv,  { "cCodFam",   "C", 16,   0, "Código de familia",                "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "cGrpFam",   "C",  3,   0, "Código del grupo de familia",      "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nReq",      "N", 16,   6, "Recargo de equivalencia",          "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "mObsLin",   "M", 10,   6, "Observaciones de la linea",        "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "cPedCli",   "C", 12,   0, "Número del pedido del cliente",    "",      "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nPvpRec",   "N", 16,   6, "Precio de venta recomendado",      "",        "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nNumMed",   "N",  1,   0, "Número de mediciones",             "",          "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nMedUno",   "N", 16,   6, "Primera unidad de medición",       "",          "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nMedDos",   "N", 16,   6, "Segunda unidad de medición",       "",          "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nMedTre",   "N", 16,   6, "Tercera unidad de medición",       "",          "", "(cDbfCol)", nil } )
   ...
   aAdd( aColPedPrv,  { "nBultos",   "N", 16,   6, "Numero de bultos en líneas",       "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "cFormato",  "C",100,   0, "Formato de compra",                "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "cCodImp",   "C",  3,   0, "Código de impuesto especial",      "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nValImp",   "N", 16,   6, "Importe de impuesto especial",     "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "lLabel",    "L",  1,   0, "Lógico para marca de etiqueta",    "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nLabel",    "N",  6,   0, "Unidades de etiquetas a imprimir", "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "cRefAux",   "C", 18,   0, "Referencia auxiliar",              "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "cRefAux2",  "C", 18,   0, "Segunda referencia auxiliar",      "",                  "", "(cDbfCol)", nil } )
   aAdd( aColPedPrv,  { "nPosPrint", "N", 4,    0, "Posición de impresión",            "",            "", "(cDbfCol)", nil } )
