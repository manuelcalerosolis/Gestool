...
function aColPedPrv()
   ...
   aAdd( aColPedPrv,  { "cSerPed",   "C",  1,   0, "",                                 "Serie",                      "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nNumPed",   "N",  9,   0, "",                                 "Numero",                     "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "cSufPed",   "C",  2,   0, "",                                 "Sufijo",                     "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "cRef",      "C", 18,   0, "Referencia del artículo",          "Articulo",                  "", "(cDbfCol)" } )
   ...
   aAdd( aColPedPrv,  { "nIva",      "N",  6,   2, "Porcentaje de " + cImp(),          "",         "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nCanPed",   "N", 16,   6, "Cantidad pedida",                  "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nUniCaja",  "N", 16,   6, "Unidades por caja",                "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nPreDiv",   "N", 16,   6, "Precio",                           "",        "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nCanEnt",   "N", 16,   6, "Cajas recibidas",                  "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nUniEnt",   "N", 16,   6, "Unidades recibidas",               "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "cUniDad",   "C",  2,   0, cNombreUnidades(),                  "",                  "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "mLngDes",   "M", 10,   0, "Descripción larga",                "",                  "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nDtoLin",   "N",  6,   2, "Descuento en lineas",              "",       "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nDtoPrm",   "N",  6,   2, "Descuento pormociones",            "",       "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nDtoRap",   "N",  6,   2, "Descuento por rappels",            "",       "", "(cDbfCol)" } )
   ...
   aAdd( aColPedPrv,  { "nCtlStk",   "N",  1,   0, "Control de stock (1,2,3)",         "",               "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "cAlmLin" ,  "C", 16,   0, "Código de almacén" ,               "",                  "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "lLote",     "L",  1,   0, "",                                 "",                  "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nLote",     "N",  9,   0, "",                                 "",       "", "(cDbfCol)" } ) 
   aAdd( aColPedPrv,  { "cLote",     "C", 14,   0, "Número de lote",                   "",                  "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nNumLin",   "N",  4,   0, "Número de la línea",               "",            "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nUndKit",   "N", 16,   6, "Unidades del producto kit",        "",          "", "(cDbfCol)" } )
   ...
   aAdd( aColPedPrv,  { "cPedCli",   "C", 12,   0, "Número del pedido del cliente",    "",      "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nPvpRec",   "N", 16,   6, "Precio de venta recomendado",      "",        "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nNumMed",   "N",  1,   0, "Número de mediciones",             "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nMedUno",   "N", 16,   6, "Primera unidad de medición",       "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nMedDos",   "N", 16,   6, "Segunda unidad de medición",       "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nMedTre",   "N", 16,   6, "Tercera unidad de medición",       "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nStkAct",   "N", 16,   6, "",                                 "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nStkMin",   "N", 16,   6, "",                                 "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nPdtRec",   "N", 16,   6, "",                                 "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nConRea",   "N", 16,   6, "",                                 "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nConSem",   "N", 16,   6, "",                                 "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nConQui",   "N", 16,   6, "",                                 "",          "", "(cDbfCol)" } )
   aAdd( aColPedPrv,  { "nConMes",   "N", 16,   6, "",                                 "",          "", "(cDbfCol)" } )
   ...
   aAdd( aColPedPrv,  { "nPosPrint", "N", 4,    0, "Posición de impresión",            "",            "", "(cDbfCol)" } )
