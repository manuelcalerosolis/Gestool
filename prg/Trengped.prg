...
METHOD OpenFiles() CLASS TRenGPed
...
METHOD lResource( cFld ) CLASS TRenGPed
...
METHOD lGenerate() CLASS TRenGPed
   ...
   ::oMtrInf:AutoInc( ::oPedCliL:Recno() )
