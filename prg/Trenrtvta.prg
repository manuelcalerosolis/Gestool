...
CLASS TRenRTVta FROM TInfTip
   ...
   DATA  nTotAtipico    AS NUMERIC   INIT 0
...
METHOD Create()
   ...
   ::AddGroup( {|| ::oDbf:cCodTip + ::oDbf:cCodArt },    {|| "Artículo : " + Rtrim( ::oDbf:cCodArt ) + "-" + Rtrim( oRetFld( ::oDbf:cCodArt, ::oDbfArt ) ) }, {||Space(1)} )
...
METHOD lGenerate()
   ...
   ::aHeader   := {  {|| "Fecha     : " + Dtoc( Date() ) },;
                     ...
                     {|| "Rnt med   : " + Alltrim( Trans( ( ( ( ( ::nTotVentas - ::nTotAtipico ) / ::nTotCosto ) - 1 )* 100 ), ::cPicOut ) ) + "%" } }
