...
METHOD OpenFiles() CLASS TRenOFac
   ...
   DATABASE NEW ::oFacRecT PATH ( cPatEmp() ) FILE "FACCLIT.DBF"  VIA ( cDriver() ) SHARED INDEX "FACCLIT.CDX"
...
METHOD lResource( cFld ) CLASS TRenOFac
...
METHOD lGenerate() CLASS TRenOFac
