...
CLASS PAcuDiaOperarios FROM TNewInfGen
...
METHOD OpenFiles() CLASS PAcuDiaOperarios
...
METHOD CloseFiles() CLASS PAcuDiaOperarios
...
METHOD lResource( cFld ) CLASS PAcuDiaOperarios
...
METHOD lGenerate() CLASS PAcuDiaOperarios
