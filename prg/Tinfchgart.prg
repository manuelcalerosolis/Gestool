...
METHOD Create()
   ...
   ::AddField( "pVtaIva1", "N", 15, 6, {|| ::cPicOut },   'Precio 1 IGIC',   .t., 'Precio de venta 1 IGIC'  , 12, .f. )
   ::AddField( "pVenta2",  "N", 15, 6, {|| ::cPicOut },   'Precio 2',       .f., 'Precio de venta 2'      , 12, .f. )
   ::AddField( "pVtaIva2", "N", 15, 6, {|| ::cPicOut },   'Precio 2 IGIC',   .f., 'Precio de venta 2 IGIC'  , 12, .f. )
   ::AddField( "pVenta3",  "N", 15, 6, {|| ::cPicOut },   'Precio 3',       .f., 'Precio de venta 3'      , 12, .f. )
   ::AddField( "pVtaIva3", "N", 15, 6, {|| ::cPicOut },   'Precio 3 IGIC',   .f., 'Precio de venta 3 IGIC'  , 12, .f. )
   ::AddField( "pVenta4",  "N", 15, 6, {|| ::cPicOut },   'Precio 4',       .f., 'Precio de venta 4'      , 12, .f. )
   ::AddField( "pVtaIva4", "N", 15, 6, {|| ::cPicOut },   'Precio 4 IGIC',   .f., 'Precio de venta 4 IGIC'  , 12, .f. )
   ::AddField( "pVenta5",  "N", 15, 6, {|| ::cPicOut },   'Precio 5',       .f., 'Precio de venta 5'      , 12, .f. )
   ::AddField( "pVtaIva5", "N", 15, 6, {|| ::cPicOut },   'Precio 5 IGIC',   .f., 'Precio de venta 5 IGIC'  , 12, .f. )
   ::AddField( "pVenta6",  "N", 15, 6, {|| ::cPicOut },   'Precio 6',       .f., 'Precio de venta 6'      , 12, .f. )
   ::AddField( "pVtaIva6", "N", 15, 6, {|| ::cPicOut },   'Precio 6 IGIC',   .f., 'Precio de venta 6 IGIC'  , 12, .f. )
