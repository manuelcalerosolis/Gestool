...
CLASS SQLPedidosVentasLineasModel FROM SQLOperacionesComercialesLineasModel

   DATA cTableName            INIT  "pedidos_ventas_lineas"

   DATA cGroupBy              INIT  "pedidos_ventas_lineas.id" 
