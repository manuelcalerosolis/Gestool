...
CLASS SQLPresupuestosVentasLineasModel FROM SQLOperacionesComercialesLineasModel

   DATA cTableName            INIT  "presupuestos_ventas_lineas"

   DATA cGroupBy              INIT  "presupuestos_ventas_lineas.id" 
