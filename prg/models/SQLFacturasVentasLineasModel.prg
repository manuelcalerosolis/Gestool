...
CLASS SQLFacturasVentasLineasModel FROM SQLOperacionesComercialesLineasModel

   DATA cTableName            INIT  "facturas_ventas_lineas"

   DATA cGroupBy              INIT  "facturas_ventas_lineas.id" 
