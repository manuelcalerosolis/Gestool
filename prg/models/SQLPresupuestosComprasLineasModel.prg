...
CLASS SQLPresupuestosComprasLineasModel FROM SQLOperacionesComercialesLineasModel

   DATA cTableName            INIT  "presupuestos_compras_lineas"

   DATA cGroupBy              INIT  "presupuestos_compras_lineas.id" 
