...
CLASS SQLFacturasComprasRectificativasLineasModel FROM SQLOperacionesComercialesLineasModel

   DATA cTableName            INIT  "facturas_compras_rectificativas_lineas"

   DATA cGroupBy              INIT  "facturas_compras_rectificativas_lineas.id" 
