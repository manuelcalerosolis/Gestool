...
CLASS SQLFacturasVentasRectificativasLineasModel FROM SQLOperacionesComercialesLineasModel

   DATA cTableName            INIT  "facturas_ventas_rectificativas_lineas"

   DATA cGroupBy              INIT  "facturas_ventas_rectificativas_lineas.id" 
