...
#define _CDIRCLI            10      //,"C", 60, 0, "direcci�n del cliente" },;
#define _CPOBCLI            11      //,"C", 25, 0, "Poblaci�n del cliente" },;
#define _CPRVCLI            12      //,"C", 20, 0, "Provincia del cliente" },;
#define _NCODPROV           13      //,"N",  2, 0, "N�mero de provincia cliente" },;
#define _CPOSCLI            14      //,"C",  5, 0, "Codigos postal del cliente" },;
#define _CDNICLI            15      //,"C", 15, 0, "DNI/CIF del cliente" },;
#define _LMODCLI            16
#define _LMAYOR             17      //,"L",  1, 0, "L�gico de mayorista" },;
#define _NTARIFA            18      //,"L",  1, 0, "L�gico de mayorista" },;
...
#define _CCODOBR            22      //,"C",  3, 0, "Codigo de la direcci�n" },;
#define _NPCTCOMAGE         23      //,"N",  6, 2, "Porcentaje de comisi�n del agente" },;
#define _LLIQUIDADA         24      //,"L",  1, 0, "L�gico de la liquidaci�n" },;
#define _LCONTAB            25      //,"L",  1, 0, "L�gico de la contabilizaci�n" },;
#define _DFECENT            26      //,"D",  8, 0, "Fecha de entrega" },;
#define _CSUFAC             27      //,"C", 10, 0, "Su factura" },;
#define _LIMPALB            28      //,"L", 10, 0, "Su pedido" },;
#define _CCONDENT           29      //,"C", 20, 0, "Condici�n de entrada" },;
...
#define _NBULTOS            33      //,"N",  3, 0, "N�mero de bultos" },;
#define _NPORTES            34      //,"N",  6, 0, "Valor de los portes" },;
#define _NIVAMAN            35      //,"N",  6, 0, "IvaValor de la mano de direcci�n" },;
#define _NMANOBR            36      //,"N",  6, 0, "Valor de la mano de direcci�n" },;
#define _CNUMALB            37      //,"C", 12, 0, "N�mero de albaran" },;
#define _CNUMPED            38      //,"C", 12, 0, "N�mero de pedido
#define _CNUMPRE            39      //,"C", 12, 0, "N�mero de presupuesto
#define _CNUMSAT            40      //,"C", 12, 0, "N�mero de presupuesto
#define _NTIPOFAC           41      //,"N",  1, 0, "N�mero del tipo de factura" },;
...
#define _CDTOUNO            46      //,"C", 25, 0, "Descripci�n de porcentaje de descuento personalizado"
#define _NDTOUNO            47      //,"N",  4, 1, "Porcentaje de descuento por descuento personalizado"
#define _CDTODOS            48      //,"C", 25, 0, "Descripci�n de porcentaje de descuento personalizado"
...
#define _NTIPOIVA           55      //,"N",  1, 0, "N�mero del tipo de " + cImp() },;
#define _NPORCIVA           56      //,"N",  4, 1, "Porcentaje de " + cImp() },;
#define _LRECARGO           57      //,"L",  1, 0, "L�gico para recargo" },;
#define _CREMITIDO          58      //,"C", 50, 0, "Campo de remitido" },;
#define _LIVAINC            59      //,"N",  1, 0, "Selecci�n de " + cImp() },;
#define _LSNDDOC            60      //,"L",  1, 0, "L�gico para documento enviado" },;
...
#define _CCODPRO            67
#define _CDOCORG            68
#define _NNUMLIQ            69     //"N",  9, 0, "N�mero liquidaci�n" }                                  "",                   "", "( cDbf )"} )
#define _CSUFLIQ            70     //"C",  2, 0, "Sufijo liquidaci�n" }                                  "",                   "", "( cDbf )"} )
#define _NIMPLIQ            71     //"N", 16, 6, "Importe liquidaci�n" }                                 "",                   "", "( cDbf )"} )
...
#define _CABNFAC            76     //"C", 12, 0, "N�mero de presupuesto
#define _CANTFAC            77     //"C", 12, 0, "N�mero de presupuesto
#define _NTIPRET            78
#define _NPCTRET            79
#define _CCODUSR            80
#define _DFECCRE            81
...
#define _CCODDLG            87
#define _NDTOATP            88      //   N      6     2     Porcentaje de descuento at�pico
#define _NSBRATP            89      //   N      1     0     Lugar donde aplicar dto at�pico
#define _DFECENTR           90
#define _DFECSAL            91
   ...
   */
   ...
   if oUser():lAdministrador()
      ...
      DEFINE BTNSHELL RESOURCE "Document_plain_earth_" OF oWndBrw ;
         NOBORDER ;
         ACTION   ( aGetSelRec( oWndBrw, {|lChk1, lChk2, oTree| CreateFileFacturae( oTree, lChk1, lChk2 ) }, "Exportar facturas electr�nicas a Facturae v 3.2", .f., "Firmar digitalmente (necesita runtime de Java)", .t., "Enviar por correo electr�nico" ) ) ;
...
FUNCTION imprimeFacturaCliente( cNumeroFactura, cFormatoDocumento )
   ...
   if OpenFiles()
      ...
      if dbSeekInOrd( cNumeroFactura, "nNumFac", D():FacturasClientes( nView ) )
         ...
         msgStop( "N�mero de factura " + alltrim( cNumeroFactura ) + " no encontrado" )
         ...
         if uFieldEmpresa( "lGrpEnt" ) // agrupamos las entregas en una sola
            ...
            */
            ...
            if nTotEntAlb != 0
               ...
               ( dbfTmpPgo )->cDescrip := "Suma entregas a cuenta albar�n: " + ( dbfAlbCliT )->cSerAlb + "/" + AllTrim( str( ( dbfAlbCliT )->nNumAlb ) ) + "/" + ( dbfAlbCliT )->cSufAlb
               ( dbfTmpPgo )->( dbUnLock() )
            ...
            if ( dbfAlbCliP )->( dbSeek( cAlbaran ) )
               ...
               while ( dbfAlbCliP )->cSerAlb + str( ( dbfAlbCliP )->nNumAlb ) + ( dbfAlbCliP )->cSufAlb == cAlbaran .and. !( dbfAlbCliP )->( Eof() )
                  ...
                  ( dbfTmpPgo )->cDescrip := "Entrega n� " + AllTrim( str( ( dbfTmpPgo )->( RecNo() ) ) ) + " albar�n " + ( dbfAlbCliP )->cSerAlb + "/" + AllTrim( str( ( dbfAlbCliP )->nNumAlb ) ) + "/" + ( dbfAlbCliP )->cSufAlb
                  end if
               ...
               */
               ...
               if ( dbfPedCliP )->( dbSeek( cPedido ) )
                  ...
                  while ( dbfPedCliP )->cSerPed + str( ( dbfPedCliP )->nNumPed ) + ( dbfPedCliP )->cSufPed == cPedido .and. !( dbfPedCliP )->( Eof() )
                     ...
                     ( dbfTmpPgo )->cDescrip := "Entrega n� " + AllTrim( str( ( dbfTmpPgo )->( RecNo() ) ) ) + " pedido " + ( dbfPedCliP )->cSerPed + "/" + AllTrim( str( ( dbfPedCliP )->nNumPed ) ) + "/" + ( dbfPedCliP )->cSufPed
                     end if
   ...
   MENU oMenu
      ...
      MENUITEM    "&1. Rotor"
         ...
         MENU
            ...
            MENUITEM    "&9. Modificar direcci�n";
   ...
   */
   ...
   /*DEFINE DIALOG oDlg RESOURCE "Dialog_Pda"
      ...
      REDEFINE COMBOBOX oCbxOrden ;
         VAR      cCbxOrden ;
         ID       110 ;
         ITEMS    { "N�mero", "Fecha", "C�digo", "Nombre" } ;
         OF       oDlg
...
Static Function DataReport( oFr )
   ...
   */
   ...
   oFr:SetWorkArea(     "Pa�s", oPais:Select() )
   oFr:SetFieldAliases( "Pa�s", cObjectsToReport( oPais:oDbf ) )
   ...
   oFr:SetMasterDetail( "Lineas de facturas", "Art�culos",                    {|| ( D():FacturasClientesLineas( nView ) )->cRef } )
   ...
   if OpenFiles()
      ...
      while !( D():FacturasClientesLineas( nView ) )->( eof() )
         ...
         */
         ...
         /*
         Esto es para la jaca para que las l�neas tengan la misma comisi�n de agente que la cabecera
         */
...
function aColFacCli()
   ...
   aAdd( aColFacCli, { "cCodAge"    ,"C",  3, 0, "C�digo del agente"                      , "Agente",                      "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "nCtlStk"    ,"N",  1, 0, "Tipo de stock de la l�nehba"            , "TipoStock",                   "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cAlmLin"    ,"C", 16, 0, "C�digo de almac�n"                      , "Almacen",                     "", "( cDbfCol )", {|| oUser():cAlmacen() } } )
   ...
   aAdd( aColFacCli, { "cLote"      ,"C", 14, 0, "N�mero de lote"                         , "Lote",                        "", "( cDbfCol )", nil } )
...
function aItmFacCli()
   ...
   aAdd( aItmFacCli, {"cCodAlm"     ,"C", 16, 0, "C�digo de almac�n" ,                                         "Almacen",                     "", "( cDbf )", {|| oUser():cAlmacen() } } )
   aAdd( aItmFacCli, {"cCodCaj"     ,"C",  3, 0, "C�digo de caja" ,                                            "Caja",                        "", "( cDbf )", {|| oUser():cCaja() } } )
   ...
   aAdd( aItmFacCli, {"lImpAlb"     ,"L",  1, 0, "L�gico si la factura se import� de Facturas" ,               "ImportadaAlbaran",            "", "( cDbf )", nil } )
   ...
   aAdd( aItmFacCli, {"cCodUsr"     ,"C",  3, 0, "C�digo de usuario",                                          "Usuario",                     "", "( cDbf )", {|| cCurUsr() } } )
   ...
   aAdd( aItmFacCli, {"cCodDlg"     ,"C",  2, 0, "C�digo delegaci�n" ,                                         "Delegacion",                  "", "( cDbf )", {|| oUser():cDelegacion() } } )
...
Function aSerFacCli()
   ...
   aAdd( aColFacCli,  { "cAlmLin",     "C", 16,   0, "Almacen del art�culo",             "",                  "", "( cDbfCol )" } )
            ...
            */
            ...
            while ( tmpFacCliP )->( !eof() )
               ...
               if !( dbfFacCliP )->( dbSeek( ( tmpFacCliP )->cSerie + str( ( tmpFacCliP )->nNumFac ) + ( tmpFacCliP )->cSufFac + str( ( tmpFacCliP )->nNumRec ) ) )
                  ...
                  ::oSender:SetText( "A�adido recibo : " + ( tmpFacCliP )->cSerie + "/" + AllTrim( str( ( tmpFacCliP )->nNumFac ) ) + "/" +  AllTrim( ( tmpFacCliP )->cSufFac ) + "-" + str( ( tmpFacCliP )->nNumRec ) + "; " + Dtoc( ( tmpFacCliP )->dEntrada ) + "; " + AllTrim( ( tmpFacCliP )->cCodCli ) + "; " + RetClient( ( tmpFacCliP )->cCodCli, dbfCliente ) )
...
Method ProcessFrq()
   ...
   if empty( uFieldempresa( "cCodCliFrq" ) )
      ::oSender:SetText( "Debe cumplimentar el c�digo de cliente en la confifuraci�n de la empresa." )
      Return .f.
   end if 

   if empty( uFieldempresa( "cCodPrvFrq" ) )
      ::oSender:SetText( "Debe cumplimentar el c�digo de proveedor en la confifuraci�n de la empresa." )
      Return .f.
   end if 
