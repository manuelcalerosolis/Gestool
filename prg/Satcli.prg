...
function aItmSatCli()
   ...
   aAdd( aItmSatCli, { "CDIRCLI",   "C",200,  0, "Domicilio del cliente",           "'@!'",               "", "( cDbf )"} )
   aAdd( aItmSatCli, { "CPOBCLI",   "C",200,  0, "Población del cliente",           "'@!'",               "", "( cDbf )"} )
   aAdd( aItmSatCli, { "CPRVCLI",   "C",100,  0, "Provincia del cliente",           "'@!'",               "", "( cDbf )"} )
...
function aColSatCli()
   ...
   aAdd( aColSatCli, { "CVALPR1", "C",   40,  0, "Valor de la primera propiedad",    "",                   "", "( cDbfCol )" } )
   aAdd( aColSatCli, { "CVALPR2", "C",   40,  0, "Valor de la segunda propiedad",    "",                   "", "( cDbfCol )" } )
   ...
   aAdd( aColSatCli, { "CALMLIN", "C",   16,  0, "Código de almacén" ,               "",                   "", "( cDbfCol )" } )
