...
function aItmSatCli()
   ...
   aAdd( aItmSatCli, { "NTARIFA",   "N",  1,  0, "Tarifa de precio aplicada" ,                  "Tarifa",           "", "( cDbf )", nil } )
   ...
   aAdd( aItmSatCli, { "cManObr",   "C",250,  0, "Literal de gastos" ,                          "LiteralGastos",           "", "( cDbf )", {|| Padr( "Gastos", 250 ) } } )      
   ...
   aAdd( aItmSatCli, { "cCodCat",   "C",  3,  0, "Código categoría" ,                           "Categoria",               "", "( cDbf )", nil } )                  
...
function aColSatCli()
   ...
   aAdd( aColSatCli, { "CVALPR1", "C",   40,  0, "Valor de la primera propiedad",                     "ValorPropiedad1",         "", "( cDbfCol )", nil } )
   aAdd( aColSatCli, { "CVALPR2", "C",   40,  0, "Valor de la segunda propiedad",                     "ValorPropiedad2",         "", "( cDbfCol )", nil } )
   ...
   aAdd( aColSatCli, { "CLOTE",   "C",   12,  0, "Número de Lote",                                    "",                        "", "( cDbfCol )", nil } )
   ...
   aAdd( aColSatCli, { "CCODTIP", "C",    3,  0, "Código del tipo de artículo",                       "Tipo",                    "", "( cDbfCol )", nil } )
   ...
   aAdd( aColSatCli, { "nTarLin"  ,"N",   1,  0, "Tarifa de precio aplicada" ,                        "Tarifa",                  "", "( cDbfCol )", nil } )
