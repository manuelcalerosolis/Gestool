...
CLASS TAcuTFacRec FROM TInfTip
...
METHOD OpenFiles() CLASS TAcuTFacRec
...
METHOD CloseFiles() CLASS TAcuTFacRec
...
METHOD lResource( cFld ) CLASS TAcuTFacRec
...
METHOD lGenerate() CLASS TAcuTFacRec
