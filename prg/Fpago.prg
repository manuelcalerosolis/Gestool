...
FUNCTION pdaBrwFPago( oGet, dbfFormasPago, oGet2, lBigStyle )
   ...
   if lBigStyle
...
#else
      DEFINE DIALOG oDlg RESOURCE "HELPENTRY_PDA"  TITLE "Seleccionar formas de pago"
#endif
      ...
      REDEFINE LISTBOX oBrw ;
         FIELDS   ( dbfFormasPago )->cCodPago,;
                  ( dbfFormasPago )->cDesPago ;
         SIZES    80,;
                  300;
         HEADER   "Código",;
                  "Nombre" ;
