...
function aItmPreCli()
   ...
   aAdd( aItmPreCli, { "CDIRCLI",   "C",200,  0, "Domicilio del cliente",           "'@!'",               "", "( cDbf )"} )
   aAdd( aItmPreCli, { "CPOBCLI",   "C",200,  0, "Población del cliente",           "'@!'",               "", "( cDbf )"} )
   aAdd( aItmPreCli, { "CPRVCLI",   "C",100,  0, "Provincia del cliente",           "'@!'",               "", "( cDbf )"} )
...
function aColPreCli()
   ...
   aAdd( aColPreCli, { "CVALPR1", "C",   40,  0, "Valor de la primera propiedad",    "",                   "", "( cDbfCol )" } )
   aAdd( aColPreCli, { "CVALPR2", "C",   40,  0, "Valor de la segunda propiedad",    "",                   "", "( cDbfCol )" } )
   ...
   aAdd( aColPreCli, { "CALMLIN", "C",   16,  0, "Código de almacén" ,               "",                   "", "( cDbfCol )" } )
         ...
         case nDevice == IS_MAIL
            ...
            if file( cFilePdf )
               ...
               with object ( TGenMailing():New() )
                  ...
                  :SetAsunto(       "Envío de  presupuesto de cliente número " + ( D():PresupuestosClientes( nView ) )->cSerPre + "/" + Alltrim( Str( ( D():PresupuestosClientes( nView ) )->nNumPre ) ) )
