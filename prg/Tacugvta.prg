...
METHOD OpenFiles() CLASS TAcuGVta
...
METHOD CloseFiles() CLASS TAcuGVta
...
METHOD lResource( cFld ) CLASS TAcuGVta
...
METHOD lGenerate()
   ...
   /*Monta los filtros para las tablas de factura*/
