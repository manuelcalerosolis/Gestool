...
METHOD DefineFiles( cPath, cVia, lUniqueName, cFileName )
   ...
   DEFINE TABLE oDbf FILE ( cFileName ) CLASS ( cFileName ) ALIAS ( cFileName ) PATH ( cPath ) VIA ( cVia ) COMMENT "Materiales producidos"
      ...
      FIELD NAME "CCODPR1"    TYPE "C" LEN  10 DEC  0 COMMENT "Código de primera propiedad"        OF oDbf
      FIELD NAME "CCODPR2"    TYPE "C" LEN  10 DEC  0 COMMENT "Código de segunda propiedad"        OF oDbf
      FIELD NAME "CVALPR1"    TYPE "C" LEN  10 DEC  0 COMMENT "Valor de primera propiedad"         OF oDbf
      FIELD NAME "CVALPR2"    TYPE "C" LEN  10 DEC  0 COMMENT "Valor de segunda propiedad"         OF oDbf
