...
CLASS TComercio
   ...
   METHOD buildProductInformationAndUploadPrestashop( id )
...
METHOD InsertImageProductPrestashopShop( hArticuloData, hImage, idProductPrestashop, idImagenPrestashop )
...
METHOD BuildInsertProductsPrestashop( hArticuloData ) CLASS TComercio
   ...
   */
   ...
   if hGet( hArticuloData, "lPublicRoot" )
...
METHOD buildInsertImageProductsPrestashop( hArticuloData, idProductPrestashop ) CLASS TComercio
   ...
   for each hImage in hGet( hArticuloData, "aImages" )
      ...
      if idImagenPrestashop != 0
         ...
         ::insertImageProductPrestashopShop( hArticuloData, hImage, idProductPrestashop, idImagenPrestashop )
      ...
      while ::oArtDiv:cCodArt == hGet( hArticuloData, "id" ) .and. !::oArtDiv:Eof()
         ...
         do case
            case !empty( ::oArtDiv:cValPr1 ) .and. empty( ::oArtDiv:cValPr2 )
               ...
               nCodigoPropiedad  := ::insertProductAttributePrestashop( hArticuloData, nCodigoWeb, nPrecio )
...
METHOD controllerExportPrestashop( idProduct ) Class TComercio
   ...
   // BEGIN SEQUENCE
      ...
      ::buildProductInformationAndUploadPrestashop( idProduct, .f. )
...
METHOD buildAddInformacionStockProductPrestashop( hProduct ) CLASS tComercio
   ...
   aAdd( ::aStockProductData, {  "cCodArt"               => idProduct ,;
                                 "cCodPrp1"              => idFirstProperty ,;
                                 "cCodPrp2"              => idSecondProperty ,;
                                 "cValPrp1"              => valueFirstProperty ,;
                                 "cValPrp2"              => valueSecondProperty ,;
                                 "nStock"                => nUnidadesStock,;
                                 "idProductPrestashop"   => ::TPrestashopId:getValueProduct( idProduct, ::getCurrentWebName() ),;
                                 "cCodWebVal1"           => ::TPrestashopId:getValueAttribute( idFirstProperty + valueFirstProperty, ::getCurrentWebName() ),;
                                 "cCodWebVal2"           => ::TPrestashopId:getValueAttribute( idSecondProperty + valueSecondProperty, ::getCurrentWebName() ) } )
