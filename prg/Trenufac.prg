...
METHOD OpenFiles() CLASS TRenUFac
...
METHod lResource( cFld ) CLASS TRenUFac
...
METHOD lGenerate() CLASS TRenUFac
   ...
   */
   ...
   while !::lBreak .and. !::oFacRecT:Eof()
      ...
      if lChkSer( ::oFacREcT:cSerie, ::aSer )
         ...
         if ::oFacCliL:Seek( ::oFacRecT:cSerie + Str( ::oFacRecT:nNumFac ) + ::oFacRecT:cSufFac )
