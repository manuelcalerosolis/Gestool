...
METHOD CreateFields()
   ...
   ::AddField ( "cGrpFam", "C",  5, 0, {|| "@!" },       "Cod",           .f., "Codigo",              5, .f. )
   ::AddField ( "cNomGrp", "C", 40, 0, {|| "@!" },       "Grp. Familia",  .f., "Grupo de familia",   40, .f. )
...
METHOD AnuGrpFields()
   ...
   ::AddField ( "cGrpFam", "C",  5, 0, {|| "@!" },         "Cod.",            .t., "Código",           5 )
   ::AddField ( "cNomGrp", "C", 40, 0, {|| "@!" },         "Grp. Fam.",       .t., "Grupo de familia",40 )
...
METHOD AcuCreate()
   ...
   ::AddField ( "cGrpFam", "C",  5, 0, {|| "@!" },           "Grp. grupo",    .t., "Cod. grupo"        ,  5, .f. )
...
METHOD AddPed( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oPedPrvL:cGrpFam )
...
METHOD AddAlb( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oAlbPrvL:cGrpFam )
...
METHOD AddFac( lAcumula )
   ...
   if !lAcumula .or. !::oDbf:Seek( ::oFacPrvL:cGrpFam )
