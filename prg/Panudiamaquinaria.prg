...
CLASS PAnuDiaMaquinaria FROM TNewInfGen
...
METHOD Create() CLASS PAnuDiaMaquinaria
...
METHOD OpenFiles() CLASS PAnuDiaMaquinaria
...
METHOD CloseFiles() CLASS PAnuDiaMaquinaria
...
METHOD lResource( cFld ) CLASS PAnuDiaMaquinaria
...
METHOD lGenerate() CLASS PAnuDiaMaquinaria
         ...
         if ::oProduccT:oDetMaquina:oDbf:Seek( ::oProduccT:oDbf:cSerOrd + Str( ::oProduccT:oDbf:nNumOrd ) + ::oProduccT:oDbf:cSufOrd )
            ...
            while ::oProduccT:oDetMaquina:oDbf:cSerOrd + Str( ::oProduccT:oDetMaquina:oDbf:nNumOrd ) + ::oProduccT:oDetMaquina:oDbf:cSufOrd == ::oProduccT:oDbf:cSerOrd + Str( ::oProduccT:oDbf:nNumOrd ) + ::oProduccT:oDbf:cSufOrd .and. !::oProduccT:oDetMaquina:oDbf:eof()
               ...
               */
               ...
               ::AddImporte( ::oProduccT:oDbf:dFecOrd, ( ::oProduccT:oDetMaquina:oDbf:nTotHra * ::oProduccT:oDetMaquina:oDbf:nCosHra ) )
