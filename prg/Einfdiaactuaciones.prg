...
CLASS EInfDiaActuaciones FROM TNewInfGen
...
METHOD Create()
   ...
   ::AddField( "cCodTip",  "C", 04, 0,  {|| "" }         ,  "Tipo"               , .f., "Código tipo expediente"     ,  8, .f. )
   ...
   */
   ...
   while !::lBreak .and. !::oExpediente:oDbf:Eof()
      ...
      if lChkSer( ::oExpediente:oDbf:cSerExp, ::aSer )
         ...
         ::oDbf:cNomSub    := oRetFld( ::oExpediente:oDbf:cCodSub, ::oSubTipoExpediente:oDbf, "cNomSub", "cCodSub" )
