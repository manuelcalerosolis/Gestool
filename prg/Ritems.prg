...
//static bEdit1     := { |aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode, lLiteral | EdtItem( aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode, lLiteral ) }
//static bEdit2     := { |aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode | EdtColu( aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode ) }
//static bEdit3     := { |aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode | EdtBmp( aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode ) }
//static bEdit4     := { |aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode | EdtBox( aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode ) }
//static bEdit5     := { |aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode | WizItem( aTmp, aGet, dbfItm, oBrw, bWhen, bValid, nMode ) }
//static bEdit6     := { |aTmp, aGet, cDbfas, oBrw, bWhen, bValid, nMode | WizColu( aTmp, aGet, dbfItm, oBrw, bWhen, bValid, nMode ) }
//static aStrColor
//static aResColor
//static aRgbColor
//static nSeaColor
...
STATIC FUNCTION EdtDocs( aTmp, aGet, dbfDoc, oBrw, cTipoDoc, bValid, nMode )
	...
	*/
      ...
      /*REDEFINE GET aGet[ dNLENPAG ] VAR aTmp[ dNLENPAG ] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
			PICTURE	"@E 999.99" ;
         ON CHANGE( lPaintDoc( oDlg, { aTmp[ dNLENPAG ], aTmp[ dNWIDPAG ] }, { aTmp[ dNLEFT ], aTmp[ dNINICIO ], aTmp[ dNRIGHT], aTmp[ dNFIN ]} ) );
         VALID    ( lPaintDoc( oDlg, { aTmp[ dNLENPAG ], aTmp[ dNWIDPAG ] }, { aTmp[ dNLEFT ], aTmp[ dNINICIO ], aTmp[ dNRIGHT], aTmp[ dNFIN ]} ) );
         ID       150 ;
         OF       oFld:aDialogs[2] ;
         SPINNER ;
         MIN       1 ;
		...
		REDEFINE GET aGet[ dNWIDPAG ] VAR aTmp[ dNWIDPAG ] ;
			SPINNER ;
         MIN       1 ;
         MAX      30 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
      ...
      REDEFINE GET aGet[ dNLENDOC ] VAR aTmp[ dNLENDOC ] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
			PICTURE	"@E 999.99" ;
         ON CHANGE( lPaintDoc( oDlg, { aTmp[ dNLENPAG ], aTmp[ dNWIDPAG ] }, { aTmp[ dNLEFT ], aTmp[ dNINICIO ], aTmp[ dNRIGHT], aTmp[ dNFIN ]} ) );
         VALID    ( lPaintDoc( oDlg, { aTmp[ dNLENPAG ], aTmp[ dNWIDPAG ] }, { aTmp[ dNLEFT ], aTmp[ dNINICIO ], aTmp[ dNRIGHT], aTmp[ dNFIN ]} ) );
      ...
      REDEFINE GET aGet[ dNWIDDOC ] VAR aTmp[ dNWIDDOC ] ;
			SPINNER ;
         MIN       1 ;
         MAX      30 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
     ...
     REDEFINE GET oGetIni VAR aTmp[ dNINICIO ] ;
			SPINNER ;
         MIN      0 ;
         MAX      28 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
		...
		REDEFINE GET oGetLft VAR aTmp[ dNLEFT ] ;
			SPINNER ;
         MIN      0 ;
         MAX      30 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
		...
		REDEFINE GET oGetRgt VAR aTmp[ dNRIGHT] ;
			SPINNER ;
         MIN      0 ;
         MAX      30 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
		...
		REDEFINE GET oGetFin VAR aTmp[ dNFIN ] ;
			SPINNER ;
         MIN      0 ;
         MAX      28 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
      ...
      REDEFINE RADIO oRadLine VAR aTmp[ dNTYPELINE ] ;
         ID       210, 211, 212 ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         OF       oFld:aDialogs[2]*/
	...
	*/
      ...
      /*REDEFINE BUTTON ;
         ...
         OF       oFld:aDialogs[3] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinAppRec( oBrw1, bEdit5, dbfTmpItm, cCodDoc ) )

      REDEFINE BUTTON ;
         ID       503 ;
         OF       oFld:aDialogs[3] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinAppRec( oBrw1, bEdit1, dbfTmpItm, , , .t. ) )

      REDEFINE BUTTON ;
         ID       502 ;
         OF       oFld:aDialogs[3] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinDupRec( oBrw1, bEdit1, dbfTmpItm ), oBrw1:SetFocus(), oBrw1:Refresh() )

		REDEFINE BUTTON ;
			ID 		501 ;
         OF       oFld:aDialogs[3] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinEdtRec( oBrw1, bEdit1, dbfTmpItm ), oBrw1:SetFocus(), oBrw1:Refresh() )

		REDEFINE BUTTON ;
			ID 		507 ;
         OF       oFld:aDialogs[3] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( if( DBDelRec( oBrw1, dbfTmpItm ), ( oBrw1:SetFocus(), oBrw1:Refresh() ), ) )

		REDEFINE BUTTON ;
			ID 		556 ;
         OF       oFld:aDialogs[3] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( EdtPos( ( dbfDoc )->Codigo, nFil, nCol, dbfTmpItm, oBrw1 ) )
      ...
      REDEFINE IBROWSE oBrw1 ;
			FIELDS ;
                  if( ( dbfTmpItm )->lSel, aLiteral[1], "" )                        ,;
                  ( dbfTmpItm )->cLiteral                                           ,;
                  Trans( ( dbfTmpItm )->nLinea, "@E 999.99" )                       ,;
                  Trans( ( dbfTmpItm )->nColumna, "@E 999.99" )                     ,;
                  Trans( (dbfTmpItm)->nSize, "@E 999.99" )                          ,;
                  aAjuste[ Max( ( dbfTmpItm )->nAjuste, 1 ) ]                       ,;
                  ( dbfTmpItm )->cMascara                                           ,;
                  ( dbfTmpItm )->fFacename                                          ,;
                  Trans( ( dbfTmpItm )->fWidth, "@E 999" )                          ,;
                  cEstilo( ( dbfTmpItm )->fItalic, ( dbfTmpItm )->fStrikeOut )      ;
         HEAD                                                                       ;
                  ""                                                                ,;
                  "Campo"                                                           ,;
                  "Fila"                                                            ,;
         ...
         FIELDSIZES                                                                 ;
                  ...
                  45                                                                ,;
                  20                                                                ;
         JUSTIFY        .f., .f., .t., .t., .t., .f., .f., .f., .t., .f.            ;
         ALIAS          ( dbfTmpItm )                                               ;
         ID             150                                                         ;
         ON DBLCLICK    ( if( nMode != ZOOM_MODE, WinEdtRec( oBrw1, bEdit1, dbfTmpItm ), ) );
         ON RIGHT CLICK ( if( nMode != ZOOM_MODE, RigthButtonDown( nRow, nCol, nFlags, oBrw1 ), ) );
         OF             oFld:aDialogs[3]

         oBrw1:nClrPane    := {|| if( ( dbfTmpItm )->lLiteral, Rgb( 236, 233, 216 ), Rgb( 255, 255, 255 ) ) }
         oBrw1:bAdd        := {|| WinAppRec( oBrw1, bEdit1, dbfTmpItm ) }
         oBrw1:bEdit       := {|| WinEdtRec( oBrw1, bEdit1, dbfTmpItm ) }
         oBrw1:bDel        := {|| DBDelRec(  oBrw1, dbfTmpItm ) }
         oBrw1:cWndName    := "Linea de documentos detalle"
	...
	*/
      ...
      /*REDEFINE BUTTON ;
         ...
         OF       oFld:aDialogs[4] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinAppRec( oBrw2, bEdit6, dbfTmpCol ), oBrw2:refresh() )

		REDEFINE BUTTON ;
			ID 		501 ;
         OF       oFld:aDialogs[4] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinEdtRec( oBrw2, bEdit2, dbfTmpCol ), oBrw2:refresh() )

		REDEFINE BUTTON ;
			ID 		507 ;
         OF       oFld:aDialogs[4] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( DBDelRec( oBrw2, dbfTmpCol ), oBrw2:refresh() )

		REDEFINE BUTTON ;
			ID 		524 ;
         OF       oFld:aDialogs[4] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( DbSwapUp( dbfTmpCol, oBrw2 ), oBrw2:refresh() )

		REDEFINE BUTTON ;
			ID 		525 ;
         OF       oFld:aDialogs[4] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( DbSwapDown( dbfTmpCol, oBrw2 ), oBrw2:refresh() )

      REDEFINE IBROWSE oBrw2 ;
			FIELDS ;
                  ( dbfTmpCol )->cLiteral                                           ,;
                  if( ( dbfTmpCol )->NCOLUMNA == -1 .or. ( dbfTmpCol )->LAUTPOS, "Aut.", Trans( ( dbfTmpCol )->NCOLUMNA, "@E 999.99" ) ) ,;
                  Trans( ( dbfTmpCol )->NSIZE, "@E 999.99" )                        ,;
                  aAjuste[ Max( ( dbfTmpCol )->NAJUSTE , 1 ) ]                      ,;
                  ( dbfTmpCol )->cMascara                                           ,;
                  ( dbfTmpCol )->fFaceName                                          ,;
                  Trans( ( dbfTmpCol )->fWidth, "@E 999" )                          ,;
                  cEstilo( ( dbfTmpCol )->fItalic, ( dbfTmpCol )->fStrikeOut )      ;
         HEAD ;
                  "Literal"                                                         ,;
                  "Col."                                                            ,;
                  "Ancho"                                                           ,;
         ...
         FIELDSIZES ;
                  ...
                  45                                                                ,;
                  80                                                                ;
         JUSTIFY  .f., .t., .t., .f., .f., .f., .t., .f.                            ;
         ALIAS    ( dbfTmpCol );
			ID 		150 ;
         ON DBLCLICK ( if( nMode != ZOOM_MODE, WinEdtRec( oBrw2, bEdit2, dbfTmpCol ), ) ) ;
         OF       oFld:aDialogs[4]

         oBrw2:bAdd        := {|| WinAppRec( oBrw2, bEdit2, dbfTmpCol ) }
         oBrw2:bEdit       := {|| WinEdtRec( oBrw2, bEdit2, dbfTmpCol ) }
         oBrw2:bDel        := {|| DBDelRec( oBrw2, dbfTmpCol ) }
         oBrw2:cWndName    := "Linea de documentos columnas"
	...
	*/
      ...
      /*REDEFINE BUTTON ;
         ...
         OF       oFld:aDialogs[5] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinAppRec( oBrw3, bEdit3, dbfTmpBmp ) )

      REDEFINE BUTTON ;
         ID       526 ;
         OF       oFld:aDialogs[5] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinDupRec( oBrw3, bEdit3, dbfTmpBmp ) )

		REDEFINE BUTTON ;
			ID 		501 ;
         OF       oFld:aDialogs[5] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinEdtRec( oBrw3, bEdit3, dbfTmpBmp ) )

		REDEFINE BUTTON ;
			ID 		507 ;
         OF       oFld:aDialogs[5] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( DBDelRec( oBrw3, dbfTmpBmp ) )

      REDEFINE IBROWSE oBrw3 ;
			FIELDS ;
                  ( dbfTmpBmp )->CFICHERO ,;
                  Trans( ( dbfTmpBmp )->NROWTOP,      "@E 999.99" ),;
                  Trans( ( dbfTmpBmp )->NCOLTOP,      "@E 999.99" ),;
                  Trans( ( dbfTmpBmp )->NROWBOTTOM,   "@E 999.99" ),;
                  Trans( ( dbfTmpBmp )->NCOLBOTTOM,   "@E 999.99" );
			HEAD ;
						"Fichero",;
                  "Fila",;
                  "Columna",;
         ...
         ALIAS    ( dbfTmpBmp );
			ID 		150 ;
         ON DBLCLICK ( if( nMode != ZOOM_MODE, WinEdtRec( oBrw3, bEdit3, dbfTmpBmp  ), ) ) ;
         OF       oFld:aDialogs[5]

         oBrw3:bAdd           := {|| WinAppRec( oBrw3, bEdit3, dbfTmpBmp ) }
         oBrw3:bEdit          := {|| WinEdtRec( oBrw3, bEdit3, dbfTmpBmp ) }
         oBrw3:bDel           := {|| DBDelRec( oBrw3, dbfTmpBmp ) }
         oBrw3:cWndName       := "Linea de documentos imagenes"
	...
	*/
      ...
      /*REDEFINE BUTTON ;
         ...
         OF       oFld:aDialogs[6] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinAppRec( oBrw4, bEdit4, dbfTmpBox ) )

      REDEFINE BUTTON ;
         ID       526 ;
         OF       oFld:aDialogs[6] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinDupRec( oBrw4, bEdit4, dbfTmpBox ) )

		REDEFINE BUTTON ;
			ID 		501 ;
         OF       oFld:aDialogs[6] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( WinEdtRec( oBrw4, bEdit4, dbfTmpBox ) )

		REDEFINE BUTTON ;
			ID 		507 ;
         OF       oFld:aDialogs[6] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( DBDelRec( oBrw4, dbfTmpBox ) )

      REDEFINE BUTTON ;
			ID 		556 ;
         OF       oFld:aDialogs[6] ;
         WHEN     ( nMode != ZOOM_MODE ) ;
         ACTION   ( BoxPos( ( dbfDoc )->Codigo, nFilBox, nColBox, dbfTmpBox, oBrw4 ) )

      REDEFINE GET nFilBox ;
			SPINNER ;
         MIN      -99 ;
         MAX      99 ;
         PICTURE  "@E 99.99" ;
      ...
      REDEFINE IBROWSE oBrw4 ;
			FIELDS ;
                  if( (dbfTmpBox)->lSelBox, aLiteral[1], "" )      ,;
                  Trans( ( dbfTmpBox )->nRowTop,      "@E 999.99" ),;
                  Trans( ( dbfTmpBox )->nColTop,      "@E 999.99" ),;
                  Trans( ( dbfTmpBox )->nRowBottom,   "@E 999.99" ),;
                  Trans( ( dbfTmpBox )->nColBottom,   "@E 999.99" ),;
                  Trans( ( dbfTmpBox )->nTypeLine,    "99" ) ;
         HEAD ;
                  "",;
                  "Fila Sup.",;
                  "Col. Sup.",;
         ...
         ALIAS    ( dbfTmpBox );
			ID 		150 ;
         ON DBLCLICK          ( if( nMode != ZOOM_MODE, WinEdtRec( oBrw4, bEdit4, dbfTmpBox ), ) ) ;
         ON RIGHT CLICK       ( if( nMode != ZOOM_MODE, RigthButtonBox( nRow, nCol, nFlags, oBrw4 ), ) ) ;
         OF                   oFld:aDialogs[6]

         oBrw4:bAdd           := {|| WinAppRec( oBrw4, bEdit4, dbfTmpBox ) }
         oBrw4:bEdit          := {|| WinEdtRec( oBrw4, bEdit4, dbfTmpBox ) }
         oBrw4:bDel           := {|| DBDelRec(  oBrw4, dbfTmpBox ) }
         oBrw4:cWndName       := "Linea de documentos lineas"
   ...
   if nMode != ZOOM_MODE
      //oFld:aDialogs[3]:AddFastKey( VK_F3, {|| WinEdtRec( oBrw1, bEdit1, dbfTmpItm ), oBrw1:SetFocus(), oBrw1:Refresh() } )
      //oFld:aDialogs[4]:AddFastKey( VK_F4, {|| if( DBDelRec( oBrw1, dbfTmpItm ), ( oBrw1:SetFocus(), oBrw1:Refresh() ), ) } )
      //oFld:aDialogs[4]:AddFastKey( VK_F2, {|| WinAppRec( oBrw2, bEdit6, dbfTmpCol ), oBrw2:refresh() } )
      //oFld:aDialogs[4]:AddFastKey( VK_F3, {|| WinEdtRec( oBrw2, bEdit2, dbfTmpCol ), oBrw2:refresh() } )
      //oFld:aDialogs[4]:AddFastKey( VK_F4, {|| DBDelRec( oBrw2, dbfTmpCol ), oBrw2:refresh() } )
      //oFld:aDialogs[5]:AddFastKey( VK_F2, {|| WinAppRec( oBrw3, bEdit3, dbfTmpBmp ) } )
      //oFld:aDialogs[5]:AddFastKey( VK_F3, {|| WinEdtRec( oBrw3, bEdit3, dbfTmpBmp ) } )
      //oFld:aDialogs[5]:AddFastKey( VK_F4, {|| DBDelRec( oBrw3, dbfTmpBmp ) } )
      //oFld:aDialogs[6]:AddFastKey( VK_F2, {|| WinAppRec( oBrw4, bEdit4, dbfTmpBox ) } )
      //oFld:aDialogs[6]:AddFastKey( VK_F3, {|| WinEdtRec( oBrw4, bEdit4, dbfTmpBox ) } )
      //oFld:aDialogs[6]:AddFastKey( VK_F4, {|| DBDelRec( oBrw4, dbfTmpBox ) } )
      oDlg:AddFastKey( VK_F5, {|| SaveEdtDocs( aTmp, aGet, oDlg, oBrw, oBtnAceptar, cCodDoc, nMode ) } )
   end if

   //oDlg:bStart := {|| StartEdtDocs( aTmp, nMode, oBtnAceptar ) }
...
//----------------------------------------------------------------------------//
/*Static Function StartEdtDocs( aTmp, nMode, oBtnAceptar  )

   if nMode == APPD_MODE                            .or.;
      ( aTmp[ dLVISUAL ] .and. nMode == ZOOM_MODE ) .or.;
      ( aTmp[ dLVISUAL ] .and. nMode == DUPL_MODE )
   end if
...
/*Static Function EndEdtDocs( aLiteral )

   aEval( aLiteral, { | hBmp | DeleteObject( hBmp ) } )

Return .t.*/

//----------------------------------------------------------------------------//

/*STATIC FUNCTION EdtItem( aTmp, aGet, dbfItm, oBrw, bWhen, bValid, nMode, lLiteral )

	local oDlg
   local aResAjust      := { "ALIGN_LEFT", "ALIGN_CENTER", "ALIGN_RIGHT" }
   local oCbxAjust
   local aCbxAjust      := { "Izquierda", "Centro", "Derecha" }
   local cCbxAjust      := aCbxAjust[ Max( aTmp[ iNAJUSTE  ], 1 ) ]
   ...
   local cTxtColor
	...
	IF nMode == APPD_MODE
      ...
      aTmp[ iLLITERAL ] := lLiteral
      aTmp[ iFWIDTH   ] := " 8"
   ELSE
      lLiteral          := aTmp[ iLLITERAL ]
      aTmp[ iFWIDTH   ] := Str( aTmp[ iFWIDTH ], 2 )
   END IF

   cEstilo              := cEstilo( aTmp[ iFITALIC ], aTmp[ iFSTRIKEOUT ] )
   nSeaColor            := aScan( aRgbColor, aTmp[ iFCOLOR ] )

   if nSeaColor != 0
      cTxtColor         := aStrColor[ nSeaColor ]
   end if

   DEFINE DIALOG oDlg RESOURCE "CABECERA_1" TITLE if( lLiteral, "Configurando textos", "Configurando campos" )

      REDEFINE GET aGet[ iCLITERAL ] VAR aTmp[ iCLITERAL ];
         ID       110 ;
			OF 		oDlg

		REDEFINE GET aGet[ iCCAMPO ] VAR aTmp[ iCCAMPO ] ;
			ID 		120 ;
			OF 		oDlg

      REDEFINE GET aGet[ iCFICHERO ] VAR aTmp[ iCFICHERO ] ;
			ID 		130 ;
			OF 		oDlg
      ...
      REDEFINE COMBOBOX aGet[ iFCOLOR ] VAR cTxtColor;
         ID       203;
         ITEMS    aStrColor;
         BITMAPS  aResColor;
         OF       oDlg
      ...
      REDEFINE CHECKBOX aTmp[ iLNOTCAJA ] ;
         ID       230 ;
			OF 		oDlg
		...
		REDEFINE BUTTON ;
         ID       IDOK ;
			OF 		oDlg ;
         ACTION   (  aTmp[ iNAJUSTE    ] := oCbxAjust:nAt ,;
                     aTmp[ iFITALIC    ] := "Negrita" $ cEstilo ,;
                     aTmp[ iFSTRIKEOUT ] := "Cursiva" $ cEstilo ,;
                     aTmp[ iFWIDTH     ] := Val( aTmp[ iFWIDTH ] ) ,;
                     aTmp[ iFCOLOR     ] := aRgbColor[ aGet[ iFCOLOR ]:nAt ] ,;
                     WinGather( aTmp, aGet, dbfTmpItm, oBrw, nMode, nil, .f. ) ,;
                     oDlg:end( IDOK ) )
   ...
   if nMode != ZOOM_MODE
      oDlg:AddFastKey( VK_F5, {|| aTmp[ iNAJUSTE ] := oCbxAjust:nAt, aTmp[ iFITALIC ] := "Negrita" $ cEstilo, aTmp[ iFSTRIKEOUT ] := "Cursiva" $ cEstilo, aTmp[ iFWIDTH ] := Val( aTmp[ iFWIDTH ] ), aTmp[ iFCOLOR ] := aRgbColor[ aGet[ iFCOLOR ]:nAt ], WinGather( aTmp, aGet, dbfTmpItm, oBrw, nMode, nil, .f. ) , oDlg:end( IDOK ) } )
   end if

   oDlg:AddFastKey( VK_F1, {|| ChmHelp( "ConfigurarDocumentos" ) } )

   ACTIVATE DIALOG oDlg CENTER ;
         ON INIT  ( if( lLiteral, aGet[ iCFICHERO ]:hide(), ) )

RETURN ( oDlg:nResult == IDOK )*/

//----------------------------------------------------------------------------//

/*STATIC FUNCTION EdtPos( cCod, nFil, nCol, dbf, oLbx )

   local nRec     := ( dbf )->( Recno() )
   local nOrd     := ( dbf )->( OrdSetFocus( 0 ) )

   ( dbf )->( dbGoTop() )
   while !( dbf )->( eof() )

      if ( dbf )->Codigo == cCod .and. ( dbf )->lSel

         if dbDialogLock( dbf )

            ( dbf )->nLinea   := ( dbf )->nLinea   + nFil
            ( dbf )->nColumna := ( dbf )->nColumna + nCol
            ( dbf )->( dbUnlock() )
...
/*STATIC FUNCTION BoxPos( cCod, nFil, nCol, dbf, oLbx )
   ...
   while !( dbf )->( eof() )
      ...
      if ( dbf )->Codigo == cCod .and. ( dbf )->lSelBox

         if dbDialogLock( dbf )

            ( dbf )->nRowTop     := ( dbf )->nRowTop     + nFil
            ( dbf )->nColTop     := ( dbf )->nColTop     + nCol
            ( dbf )->nRowBottom  := ( dbf )->nRowBottom  + nFil
            ( dbf )->nColBottom  := ( dbf )->nColBottom  + nCol
...
/*STATIC FUNCTION LoaFldDoc( aGet, dbfFldDoc )

	local xVal	:= aGet[ iCLITERAL ]:varGet()
...
/*STATIC FUNCTION EdtColu( aTmp, aGet, dbfCol, oBrw, bWhen, bValid, nMode )

	local oDlg
	local oCbxAjust
	local cCbxAjust
   local aResAjust      := { "ALIGN_LEFT", "ALIGN_CENTER", "ALIGN_RIGHT" }
   local aItems         := { "Izquierda", "Centro", "Derecha" }
   local aFont          := aGetFont( oWnd() )
   local aSizes         := { " 6", " 7", " 8", " 9", "10", "11", "12", "13", "14", "16", "18", "20", "22", "24", "26", "28", "36", "48", "72" }
   local oEstilo
   local cEstilo        := "Normal"
   ...
   IF aTmp[ cNAJUSTE ]  == 0
	...
	IF nMode == APPD_MODE
      ...
      cCbxAjust         := "Derecha"
	ELSE
		cCbxAjust			:= aItems[ aTmp[ cNAJUSTE ] ]
      aTmp[ cFWIDTH ]   := Str( aTmp[ cFWIDTH ], 2 )
   END IF

   cEstilo              := cEstilo( aTmp[ cFITALIC ], aTmp[ cFSTRIKEOUT ] )
   nSeaColor            := aScan( aRgbColor, aTmp[ cFCOLOR ] )

   if nSeaColor != 0
      cTxtColor         := aStrColor[ nSeaColor ]
   end if

	DEFINE DIALOG oDlg RESOURCE "CABECERA_2"
      ...
      REDEFINE COMBOBOX aGet[ cFCOLOR ] VAR cTxtColor;
         ID       203;
         ITEMS    aStrColor;
         BITMAPS  aResColor;
         OF       oDlg
		...
		REDEFINE BUTTON ;
         ID       IDOK ;
			OF 		oDlg ;
         ACTION   (  aTmp[ cNAJUSTE    ] := oCbxAjust:nAt ,;
                     aTmp[ cFITALIC    ] := "Negrita" $ cEstilo ,;
                     aTmp[ cFSTRIKEOUT ] := "Cursiva" $ cEstilo ,;
                     aTmp[ cFWIDTH     ] := Val( aTmp[ cFWIDTH ] ) ,;
                     aTmp[ cFCOLOR     ] := aRgbColor[ aGet[ cFCOLOR ]:nAt ] ,;
                     WinGather( aTmp, aGet, dbfTmpCol, oBrw, nMode, nil, .f. ) ,;
                     oDlg:end( IDOK ) )
   ...
   if nMode != ZOOM_MODE
      oDlg:AddFastKey( VK_F5, {|| aTmp[ cNAJUSTE    ] := oCbxAjust:nAt, aTmp[ cFITALIC    ] := "Negrita" $ cEstilo, aTmp[ cFSTRIKEOUT ] := "Cursiva" $ cEstilo, aTmp[ cFWIDTH     ] := Val( aTmp[ cFWIDTH ] ), aTmp[ cFCOLOR     ] := aRgbColor[ aGet[ cFCOLOR ]:nAt ], WinGather( aTmp, aGet, dbfTmpCol, oBrw, nMode, nil, .f. ), oDlg:end( IDOK ) } )
   end if
...
/*STATIC FUNCTION EdtBmp( aTmp, aGet, dbfCol, oBrw, bWhen, bValid, nMode )
	...
	DEFINE DIALOG oDlg RESOURCE "CABECERA_3"

		REDEFINE GET oBtn VAR aTmp[ bCFICHERO ] ;
			ID 		110 ;
         BITMAP   "FOLDER" ;
         ON HELP  ( oBtn:cText( cGetFile( "*.bmp", "Seleccion de Fichero" ) ), bmpFish:LoadBMP( rtrim( aTmp[ bCFICHERO ] ) ) ) ;
			OF 		oDlg

		REDEFINE GET aGet[ bNCOLTOP ] VAR aTmp[ bNCOLTOP ] ;
			ID 		120 ;
			SPINNER ;
			ON UP		aGet[ bNCOLTOP ]:cText( aGet[ bNCOLTOP ]:value + .1 ) ;
			ON DOWN	aGet[ bNCOLTOP ]:cText( aGet[ bNCOLTOP ]:value - .1 ) ;
			PICTURE "@E 999.99" ;
			OF 		oDlg

		REDEFINE GET aGet[ bNROWTOP ] VAR aTmp[ bNROWTOP ] ;
			ID 		130 ;
			SPINNER ;
			ON UP		aGet[ bNROWTOP ]:cText( aGet[ bNROWTOP ]:value + .1 ) ;
			ON DOWN	aGet[ bNROWTOP ]:cText( aGet[ bNROWTOP ]:value - .1 ) ;
			PICTURE "@E 999.99" ;
			OF 		oDlg

      REDEFINE BITMAP bmpFish ;
         ID       200 ;
         OF       oDlg ;
         FILE     aTmp[ bCFICHERO ];
         ADJUST
      bmpFish:bLDblClick = { || MsgInfo( "Hello I'm Mr. Kal :-P" ) }

		REDEFINE GET aGet[ bNCOLBOTTOM ] VAR aTmp[ bNCOLBOTTOM ] ;
			ID 		140 ;
			SPINNER ;
			ON UP		aGet[ bNCOLBOTTOM ]:cText( aGet[ bNCOLBOTTOM ]:value + .1 ) ;
			ON DOWN	aGet[ bNCOLBOTTOM ]:cText( aGet[ bNCOLBOTTOM ]:value - .1 ) ;
			PICTURE "@E 999.99" ;
			OF oDlg

		REDEFINE GET aGet[ bNROWBOTTOM ] VAR aTmp[ bNROWBOTTOM ] ;
			ID 		150 ;
			SPINNER ;
			ON UP		aGet[ bNROWBOTTOM ]:cText( aGet[ bNROWBOTTOM ]:value + .1 ) ;
			ON DOWN	aGet[ bNROWBOTTOM ]:cText( aGet[ bNROWBOTTOM ]:value - .1 ) ;
			PICTURE 	"@E 999.99" ;
			OF 		oDlg
		...
		REDEFINE BUTTON ;
         ID       IDOK ;
			OF 		oDlg ;
         ACTION ( WinGather( aTmp, aGet, dbfTmpBmp, oBrw, nMode, nil, .f. ),;
                  oDlg:end( IDOK ) )
   ...
   if nMode != ZOOM_MODE
      oDlg:AddFastKey( VK_F5, {|| WinGather( aTmp, aGet, dbfTmpBmp, oBrw, nMode, nil, .f. ), oDlg:end( IDOK ) } )
   end if
...
/*STATIC FUNCTION EdtBox( aTmp, aGet, dbfBox, oBrw, bWhen, bValid, nMode )
   ...
   local nColor
	...
	IF nMode == APPD_MODE
		aTmp[ xCODIGO ] := ( dbfDoc )->CODIGO
	END IF

	DEFINE DIALOG oDlg RESOURCE "CABECERA_4"

		REDEFINE GET aGet[ xNROWTOP ] VAR aTmp[ xNROWTOP ] ;
         ID       100 ;
			SPINNER ;
			ON UP		aGet[ xNROWTOP ]:cText( aGet[ xNROWTOP ]:value + .1 ) ;
			ON DOWN	aGet[ xNROWTOP ]:cText( aGet[ xNROWTOP ]:value - .1 ) ;
			PICTURE "@E 999.99" ;
         OF       oDlg

      REDEFINE GET aGet[ xNCOLTOP ] VAR aTmp[ xNCOLTOP ] ;
         ID       110 ;
			SPINNER ;
			ON UP		aGet[ xNCOLTOP ]:cText( aGet[ xNCOLTOP ]:value + .1 ) ;
			ON DOWN	aGet[ xNCOLTOP ]:cText( aGet[ xNCOLTOP ]:value - .1 ) ;
			PICTURE "@E 999.99" ;
         OF       oDlg

		REDEFINE GET aGet[ xNROWBOTTOM ] VAR aTmp[ xNROWBOTTOM ] ;
         ID       120 ;
			SPINNER ;
			ON UP		aGet[ xNROWBOTTOM ]:cText( aGet[ xNROWBOTTOM ]:value + .1 ) ;
			ON DOWN	aGet[ xNROWBOTTOM ]:cText( aGet[ xNROWBOTTOM ]:value - .1 ) ;
			PICTURE 	"@E 999.99" ;
			OF 		oDlg

      REDEFINE GET aGet[ xNCOLBOTTOM ] VAR aTmp[ xNCOLBOTTOM ] ;
         ID       130 ;
			SPINNER ;
			ON UP		aGet[ xNCOLBOTTOM ]:cText( aGet[ xNCOLBOTTOM ]:value + .1 ) ;
			ON DOWN	aGet[ xNCOLBOTTOM ]:cText( aGet[ xNCOLBOTTOM ]:value - .1 ) ;
			PICTURE "@E 999.99" ;
         OF       oDlg

		REDEFINE GET aGet[ xNTYPELINE ] VAR aTmp[ xNTYPELINE ] ;
         ID       140 ;
			SPINNER ;
         MIN      1 ;
         MAX      99 ;
      ...
      REDEFINE GET aGet[ ( dbfTmpBox )->( fieldpos( "Red" ) ) ] VAR aTmp[ ( dbfTmpBox )->( fieldpos( "Red" ) ) ] ;
         ID       150;
         COLOR    CLR_GET ;
         PICTURE  "999" ;
         SPINNER  MIN 0 MAX 255 ;
         ON CHANGE( oColor:SetColor( , Rgb( aTmp[ ( dbfTmpBox )->( fieldpos( "Red" ) ) ], aTmp[ ( dbfTmpBox )->( fieldpos( "Green" ) ) ], aTmp[ ( dbfTmpBox )->( fieldpos( "Blue" ) ) ] ), oColor:Refresh() ) ) ;
         OF       oDlg

      REDEFINE GET aGet[ ( dbfTmpBox )->( fieldpos( "Green" ) ) ] VAR aTmp[ ( dbfTmpBox )->( fieldpos( "Green" ) ) ] ;
         ID       160;
         COLOR    CLR_GET ;
         PICTURE  "999" ;
         SPINNER  MIN 0 MAX 255 ;
      ...
      REDEFINE GET aGet[ ( dbfTmpBox )->( fieldpos( "Blue" ) ) ] VAR aTmp[ ( dbfTmpBox )->( fieldpos( "Blue" ) ) ] ;
         ID       170;
         COLOR    CLR_GET ;
         PICTURE  "999" ;
         SPINNER  MIN 0 MAX 255 ;
      ...
      REDEFINE SAY oColor PROMPT cColor ;
         ID       180;
         COLOR    Rgb( 0, 0, 0 ), Rgb( aTmp[ ( dbfTmpBox )->( fieldpos( "Red" ) ) ], aTmp[ ( dbfTmpBox )->( fieldpos( "Green" ) ) ], aTmp[ ( dbfTmpBox )->( fieldpos( "Blue" ) ) ] ) ;
         OF       oDlg

      REDEFINE GET aGet[xLCONDICION] VAR aTmp[xLCONDICION] ;
         ID       190 ;
			OF 		oDlg
      ...
      REDEFINE BUTTON ;
         ID       200 ;
			OF 		oDlg ;
         ACTION   (  nColor         := ChooseColor(),;
                     aGet[ ( dbfTmpBox )->( fieldpos( "Red"   ) ) ]:cText( nRgbRed(   nColor ) ),;
                     aGet[ ( dbfTmpBox )->( fieldpos( "Green" ) ) ]:cText( nRgbGreen( nColor ) ),;
                     aGet[ ( dbfTmpBox )->( fieldpos( "Blue"  ) ) ]:cText( nRgbBlue(  nColor ) ),;
                     oColor:SetColor( , Rgb( aTmp[ ( dbfTmpBox )->( fieldpos( "Red" ) ) ], aTmp[ ( dbfTmpBox )->( fieldpos( "Green" ) ) ], aTmp[ ( dbfTmpBox )->( fieldpos( "Blue" ) ) ] ),;
                     oColor:Refresh() ) )

		REDEFINE BUTTON ;
         ID       IDOK ;
			OF 		oDlg ;
         ACTION   ( WinGather( aTmp, aGet, dbfTmpBox, oBrw, nMode, nil, .f. ), oDlg:end( IDOK ) )
   ...
   if nMode != ZOOM_MODE
      oDlg:AddFastKey( VK_F5, {|| WinGather( aTmp, aGet, dbfTmpBox, oBrw, nMode, nil, .f. ), oDlg:end( IDOK ) } )
   end if
