...
FUNCTION aItmRecCli()
   ...
   aAdd( aBasRecCli, {"nImpEur"     ,"N", 16, 6, "Importe del pago en Euros",                            "", "", "( cDbfRec )" } )
   ...
   aAdd( aBasRecCli, {"nImpCob"     ,"N", 16, 6, "Importe del cobro",                                    "", "", "( cDbfRec )" } )
   aAdd( aBasRecCli, {"nImpGas"     ,"N", 16, 6, "Importe de gastos",                                    "", "", "( cDbfRec )" } )
   ...
   aAdd( aBasRecCli, {"cNumMtr"     ,"C", 15, 0, "Número del recibo matriz",                             "", "", "( cDbfRec )" } )
   aAdd( aBasRecCli, {"lPasado"     ,"L",  1, 0, "Lógico pasado",                                        "", "", "( cDbfRec )" } )
   aAdd( aBasRecCli, {"cCtrCoste"   ,"C",  9, 0, "Código del centro de coste",                           "", "", "( cDbfRec )" } )
   aAdd( aBasRecCli, {"nImpRel"     ,"N", 16, 6, "Importe relacionados",                                 "", "", "( cDbfRec )" } )
