...
FUNCTION aItmRecCli()
   ...
   aAdd( aBasRecCli, {"dEntrada"    ,"D",  8, 0, "Fecha de cobro",                                       "FechaCobro",           "", "( cDbfRec )", {|| GetSysDate() } } )
   ...
   aAdd( aBasRecCli, {"cCodUsr"     ,"C",  3, 0, "Código del usuario" ,                                  "Usuario",              "", "( cDbfRec )", {|| cCurUsr() } } )
...
CLASS TFacturasClientesCobrosSenderReciver FROM TSenderReciverItem
...
Method CreateData() CLASS TFacturasClientesCobrosSenderReciver

   MsgInfo( "Entro en la funcion create data" )
