...
function aColFacRec()
   ...
   aAdd( aColFacRec, { "cValPr1"     ,"C", 40, 0, "Valor de primera propiedad"            , "ValorPropiedad1",             "", "( cDbfCol )", nil } )
   aAdd( aColFacRec, { "cValPr2"     ,"C", 40, 0, "Valor de segunda propiedad"            , "ValorPropiedad2",             "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacRec, { "cLote"       ,"C", 12, 0, "Número de lote"                        , "Lote",                        "", "( cDbfCol )", nil } )
