...
METHOD OpenFiles() CLASS TDiaAgeFac
...
METHOD CloseFiles() CLASS TDiaAgeFac
...
METHOD lResource( cFld ) CLASS TDiaAgeFac
...
METHOD lGenerate() CLASS TDiaAgeFac
   ...
   ::aHeader      := {  {|| "Fecha   : " + Dtoc( Date() ) },;
                        ...
                        {|| "Agente  : " + if( ::lAgeAll, "Todos", AllTrim( ::cAgeOrg ) + " > " + AllTrim( ::cAgeDes ) ) },;
                        {|| "Estado  : " + ::cEstado },;
                        {|| "Ordenado: " + ::cOrdenado } }
