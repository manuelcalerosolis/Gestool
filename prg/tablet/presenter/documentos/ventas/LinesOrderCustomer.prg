...
METHOD New() CLASS LinesOrderCustomer
...
/*METHOD setAeras() CLASS OrderCustomer
...
METHOD setNavigator() CLASS OrderCustomer
   ...
   if !Empty( ::oViewNavigator )
      ...
      ::oViewNavigator:SetTextoTipoDocumento( "Pedidos de cliente" )
...
METHOD PropiedadesBrowse() CLASS OrderCustomer
...
METHOD PropiedadesBrowseDetail() CLASS OrderCustomer
...
METHOD GetAppendDetail() CLASS OrderCustomer
   ...
   ::oDocumentLineTemporal      := D():GetPedidoClienteLineaBlank( ::nView )
