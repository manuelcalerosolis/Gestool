...
METHOD lGrupoAlmacen( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   ::oGrupoAlmacen:Cargo:Desde      := Space( 3 )           // dbFirst( ::oDbfAlm, 1 )
   ::oGrupoAlmacen:Cargo:Hasta      := Replicate( "Z", 3 )  // dbLast( ::oDbfAlm, 1 )
...
METHOD lGrupoOperario( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   if lInitGroup != nil
      ...
      ::oImageGroup:AddMasked( TBitmap():Define( "Worker2_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoUsuario( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   if lInitGroup != nil
      ...
      if !Empty( ::oImageGroup )
         ::oImageGroup:AddMasked( TBitmap():Define( "Businessmen_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoTransportista( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   if lInitGroup != nil
      ...
      if !Empty( ::oImageGroup )
         ::oImageGroup:AddMasked( TBitmap():Define( "Truck_Blue_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoGFamilia( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   if !Empty( ::oImageList )
      ::oImageList:AddMasked( TBitmap():Define( "Folder_Cubes_Color_16" ), Rgb( 255, 0, 255 ) )
   end if
   ...
   if lInitGroup != nil
      ...
      if !Empty( ::oImageGroup )
         ::oImageGroup:AddMasked( TBitmap():Define( "Folder_Cubes_Color_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoTipoArticulo( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   if lInitGroup != nil
      ...
      if !Empty( ::oImageGroup )
         ::oImageGroup:AddMasked( TBitmap():Define( "Cubes_Blue_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoCategoria( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   */
   ...
   if lInitGroup != nil
      ...
      if !Empty( ::oImageGroup )
         ::oImageGroup:AddMasked( TBitmap():Define( "Colors_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoRuta( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   if !Empty( ::oImageList )
      ::oImageList:AddMasked( TBitmap():Define( "Signpost_16" ), Rgb( 255, 0, 255 ) )
   end if
   ...
   if lInitGroup != nil
      ...
      if !Empty( ::oImageGroup )
         ::oImageGroup:AddMasked( TBitmap():Define( "Signpost_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoFacturasCompras( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   */
   ...
   ::oImageList:AddMasked( TBitmap():Define( "Document_businessman_16" ), Rgb( 255, 0, 255 ) )

   if lInitGroup != nil

      aAdd( ::aSelectionGroup, ::oGrupoFacturasCompras )

      ::oImageGroup:AddMasked( TBitmap():Define( "Document_businessman_16" ), Rgb( 255, 0, 255 ) )
...
METHOD lGrupoTemporada( lInitGroup, lImp ) CLASS TNewInfGen
   ...
   if lInitGroup != nil
      ...
      if !Empty( ::oImageGroup )
         ::oImageGroup:AddMasked( TBitmap():Define( "Sun_And_Cloud_16" ), Rgb( 255, 0, 255 ) )
