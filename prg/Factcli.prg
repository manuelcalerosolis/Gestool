...
function aColFacCli()
   ...
   aAdd( aColFacCli, { "cCodTip"    ,"C",  3, 0, "Código del tipo de artículo"            , "TipoArticulo",                "", "( cDbfCol )", nil } )
   ...
   aAdd( aColFacCli, { "cCtrCoste", "C",   9, 0, "Codigo del centro de coste"             , "",                            "", "( cDbfCol )", nil } )
