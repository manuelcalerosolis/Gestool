...
METHOD FldCliente()
   ...
   ::AddField( "cObrCli", "C", 10, 0,  {|| "@!" },         "Obra",                      .f., "Código obra",                12 )
...
METHOD FldPropiedades()
   ...
   ::AddField( "cCodPr1", "C", 10, 0, {|| "@!" },        "Cod. prp. 1",       .f., "Código propiedad 1",        6, .f. )
   ::AddField( "cNomPr1", "C", 35, 0, {|| "@!" },        "Nom. prp. 1",       .f., "Nombre propiedad 1",       20, .f. )
   ::AddField( "cValPr1", "C", 10, 0, {|| "@!" },        "Val. prp. 1",       .f., "Valor propiedad 1",         6, .f. )
   ::AddField( "cNomVl1", "C", 30, 0, {|| "@!" },        "Nom. val. prp. 1",  .f., "Nombre valor propiedad 1", 20, .f. )
   ::AddField( "cCodPr2", "C", 10, 0, {|| "@!" },        "Cod. prp. 2",       .f., "Código propiedad 2",        6, .f. )
   ::AddField( "cNomPr2", "C", 35, 0, {|| "@!" },        "Nom. prp. 2",       .f., "Nombre propiedad 2",       20, .f. )
   ::AddField( "cValPr2", "C", 10, 0, {|| "@!" },        "Val. prp. 2",       .f., "Valor propiedad 2",         6, .f. )
...
METHOD MakeVisor()
   ...
   fWrite( ::hFile,  "{"                                                   + CRLF )
   fWrite( ::hFile,  "var IGICl = parseInt(oSel.options(i).innerText);"     + CRLF )
   fWrite( ::hFile,  "if (newZoom == IGICl)"                                + CRLF )
   fWrite( ::hFile,  "{"                                                   + CRLF )
