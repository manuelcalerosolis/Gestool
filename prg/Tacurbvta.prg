...
METHOD Create()
   ...
   ::AddField( "nPorPrv", "N",  6, 2, {|| "999.99"},   "% Vta. prv.",   .t., "% Del artículo por proveedor" , 12, .f. )
...
METHOD lGenerate()
   ...
   */
   ...
   /*Calculamos el procentaje que representa un artículo para un proveedor*/
