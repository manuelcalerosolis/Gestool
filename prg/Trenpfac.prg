...
METHOD OpenFiles() CLASS TRenPFac
...
METHOD CloseFiles() CLASS TRenPFac
...
METHOD lResource( cFld ) CLASS TRenPFac
   ...
   /*
   Monta los Trasnportistas de manera automatica
   */
...
METHOD lGenerate() CLASS TRenPFac
      ...
      if lChkSer( ::oFacRecT:cSerie, ::aSer )
         ...
         if ::oFacRecL:Seek( ::oFacRecT:cSerie + Str( ::oFacRecT:nNumFac ) + ::oFacRecT:cSufFac )
            ...
            while ::oFacRecL:cSerie + Str( ::oFacRecL:nNumFac ) + ::oFacRecL:cSufFac == ::oFacRecT:cSerie + Str( ::oFacRecT:nNumFac ) + ::oFacRecT:cSufFac
               ...
               if !( ::lExcMov  .AND. ( nTotNFacCli( ::oFacRecL:cAlias ) == 0  ) )
