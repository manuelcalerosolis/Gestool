   ...
   */
   ...
   if Len( aAlbaranes ) != 0
      ...
      for each aAlbaran in aAlbaranes
         ...
         oStock:SetEstadoPedCli( aAlbaran[ 3 ], .t., cSerAlb + Str( nNumAlb ) + cSufAlb )

         if dbSeekInOrd( aAlbaran[ 3 ], "nNumPed", dbfPedCliT )
