...
METHOD OpenFiles() CLASS ORenGPed
...
METHOD CloseFiles() CLASS ORenGPed
...
METHod lResource( cFld ) CLASS ORenGPed
...
METHOD lGenerate() CLASS ORenGPed
      ...
      if lChkSer( ::oPedPrvT:cSerPed, ::aSer )
         ...
         if ::oPedPrvL:Seek( ::oPedPrvT:cSerPed + Str( ::oPedPrvT:nNumPed ) + ::oPedPrvT:cSufPed )
            ...
            while ::oPedPrvL:cSerPed + Str( ::oPedPrvL:nNumPed ) + ::oPedPrvL:cSufPed == ::oPedPrvT:cSerPed + Str( ::oPedPrvT:nNumPed ) + ::oPedPrvT:cSufPed
               ...
               if cCodGruFam( ::oPedPrvL:cRef, ::oArt, ::oDbfFam ) >= ::cGruFamOrg                     .AND.;
                  cCodGruFam( ::oPedPrvL:cRef, ::oArt, ::oDbfFam ) <= ::cGruFamDes                     .AND.;
                  ...
                  ::oDbf:cGrpFam    := cCodGruFam( ::oPedPrvL:cRef, ::oArt, ::oDbfFam )
