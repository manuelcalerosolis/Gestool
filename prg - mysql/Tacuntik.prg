...
METHOD OpenFiles() CLASS TAcuNTik
...
METHOD CloseFiles() CLASS TAcuNTik
...
METHOD lResource( cFld ) CLASS TAcuNTik

   if !::StdResource( "INFACUAGEB" )
      return .f.
   end if
...
METHOD lGenerate() CLASS TAcuNTik
