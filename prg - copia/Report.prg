...
CLASS TReport
   ...
   DATA bFor, bWhile , bInit, bEnd, bStartLine, bEndLine, bStartPage, ;
        ...
        bChange, bPostEnd, bPostPage, bPostGroup
...
METHOD New( aTitle, aHead, aFoot, aFont, aPen, lSummary, cRptFile, ;
   ...
   */
   ...
   IF oDevice <> NIL
      ...
      ::lPrinter := !::lScreen
   ELSEIF ::lPrinter
      ::oDevice  := TPrinter():New(cName,.f.,.f.,::cResName)
   ELSEIF ::lScreen
      ::oDevice  := TPrinter():New(cName,.f.,.t.,::cResName)
   ELSEIF !empty(::cFile)
   ...
   */
   ...
   Aeval(aFont                                        ,;
         ...
         val:nWidth*::nLogPixX/72              ,;
         val:nHeight*::nLogPixY/72             ,;
         .F.                                          ,;
         val:lBold                                    ,;
         val:nEscapement                              ,;
         val:nOrientation                             ,;
...
METHOD Stabilize() CLASS TReport
   ...
   */
   ...
   //Aeval( ::aColumns, {|Val| msginfo( Val:ClassName() ) } )
