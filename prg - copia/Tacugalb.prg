...
METHOD OpenFiles() CLASS TAcuGAlb
...
METHOD CloseFiles() CLASS TAcuGAlb
...
METHOD lResource( cFld ) CLASS TAcuGAlb
   ...
   /*Definimos el combo con los tipos del albarán*/
...
METHOD lGenerate() CLASS TAcuGAlb
