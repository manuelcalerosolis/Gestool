...
METHOD Create()
   ...
   ::DetCreateFields()
   ::AddField( "MNUMSER", "M", 10, 0, {|| "@!" },   "Núm. serie",  .f., "Memo con los números de serie"     , 20, .f. )
