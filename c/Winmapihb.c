...

{
    ...
    rcpt.lpszName           = _parc( 6 )   ;  // Reciepient's Name, e.g., vouchcac@hotmail.com
    ...
    _retnl( (ULONG) MAPISendMail( 0, 0, &mssg, MAPI_DIALOG, 0 ) ) ;

}

//---------------------------------------------------------------------------//

HB_FUNC( MAPISENDMAILAUTO )

{
    ...
    _retnl( (ULONG) MAPISendMail( 0, 0, &mssg, MAPI_LOGON_UI, 0 ) ) ;
