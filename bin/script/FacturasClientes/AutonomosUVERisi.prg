...
CREATE CLASS FacturasClientesRisi
   ...
   CLASSDATA aProductos    INIT  {  { "Codigo" => "V001004", "Nombre" => "GUSANITOS 35 g x 30 u",                   "Codigo unidades" => "8411859550103",     "Codigo cajas" => "18411859550100" },;
                                    ...
                                    { "Codigo" => "V025045", "Nombre" => "PATATAS OND.JAMÓN 30 g x 30 u.",          "Codigo unidades" => "8411859552169",     "Codigo cajas" => "28411859552163" },;
                                    ...
                                    { "Codigo" => "V800501", "Nombre" => "Exp. Extrusión",                          "Codigo unidades" => "8411859559977",     "Codigo cajas" => "18411859559974" } }
...
//---------------------------------------------------------------------------//
   ...
   METHOD UploadFile() CLASS FacturasClientesRisi
      ...
      if isTrue( ::oFtp:UploadFile( ::oUve:getFile() ) ) // 
         msgWait( "Fichero " + ::oUve:getFile() + "subido al ftp.", "Información", 1 )
      else
