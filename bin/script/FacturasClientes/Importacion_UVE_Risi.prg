...
METHOD insertLineUVE( aLine )
   ...
   hset( hUve, "UnidadMedición",                aLine[ 8 ] )
   hset( hUve, "PrecioBase",                    aLine[ 9 ] )
   hset( hUve, "Descuentos",                    aLine[ 10 ] )
   hset( hUve, "PrecioBrutoTotal",              aLine[ 11 ] )
   hset( hUve, "FechaFactura",                  aLine[ 12 ] )
   hset( hUve, "Ejercicio",                     aLine[ 13 ] )
   hset( hUve, "CodigoCliente",                 aLine[ 14 ] )
   hset( hUve, "Nombre",                        aLine[ 15 ] )
   hset( hUve, "RazonSocial",                   aLine[ 16 ] )
   hset( hUve, "CIF",                           aLine[ 17 ] )
   hset( hUve, "Direccion",                     aLine[ 18 ] )
   hset( hUve, "Poblacion",                     aLine[ 19 ] )
   hset( hUve, "CodigoPostal",                  aLine[ 20 ] )
   hset( hUve, "Ruta",                          aLine[ 21 ] )
   hset( hUve, "NombreRuta",                    aLine[ 22 ] )
   hset( hUve, "CodigoComercial",               aLine[ 23 ] )
   hset( hUve, "NombreComercial",               aLine[ 24 ] )
   hset( hUve, "Peso",                          aLine[ 25 ] )
   hset( hUve, "UMPeso",                        aLine[ 26 ] )
   hset( hUve, "TipoCliente",                   aLine[ 27 ] )
   hset( hUve, "Telefono",                      aLine[ 28 ] )
   hset( hUve, "DescripciónTipoCliente",        aLine[ 29 ] )
