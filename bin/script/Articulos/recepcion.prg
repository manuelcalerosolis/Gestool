...
#define __path__                    "C:\Users\Usuario\Dropbox\Buzones\0000005\"
   ...
   for each aFile in aFiles
      ...
      if isArray( aArticulos )
         ...
         for each hArticulo in aArticulos
            ...
            // if ( D():Articulos(nView) )->( dbseek( hArticulo[ "COD" ] ) )

            deleteArticulo( hArticulo )  
            appendHashRecord( hArticulo, D():Articulos( nView ), { "PCOSTO" } )
