 ...
 * Generated C source from ".\.\Prg\Tgfrped.prg"
 */
...
HB_FUNC_STATIC( TINFGRFPED_CREATE );
HB_FUNC_STATIC( TINFGRFPED_OPENFILES );
HB_FUNC_STATIC( TINFGRFPED_CLOSEFILES );
HB_FUNC_STATIC( TINFGRFPED_RESOURCE );
HB_FUNC_STATIC( TINFGRFPED_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TGFRPED )
{ "TINFGRFPED", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( TINFGRFPED )}, NULL },
...
{ "TINFGRFPED_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFGRFPED_CREATE )}, NULL },
{ "TINFGRFPED_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFGRFPED_OPENFILES )}, NULL },
{ "TINFGRFPED_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFGRFPED_CLOSEFILES )}, NULL },
{ "TINFGRFPED_RESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFGRFPED_RESOURCE )}, NULL },
{ "TINFGRFPED_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TINFGRFPED_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TGFRPED, ".\\.\\Prg\\Tgfrped.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TGFRPED
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TGFRPED )
   #include "hbiniseg.h"
#endif
...
<<<<<<< HEAD
		...
		29,129,2,176,1,0,104,2,0,12,1,29,118,2,
		166,56,2,0,122,80,1,48,2,0,176,3,0,12,
=======
		149,3,0,116,114,0,36,7,0,103,2,0,100,8,
		29,173,2,176,1,0,104,2,0,12,1,29,162,2,
		166,100,2,0,122,80,1,48,2,0,176,3,0,12,
>>>>>>> SQLite
		0,106,11,84,73,110,102,71,114,102,112,101,100,0,
...
<<<<<<< HEAD
		...
		3,73,36,23,0,48,6,0,95,2,106,9,82,101,
...
=======
		...
		108,65,110,111,0,4,1,0,9,112,5,73,36,16,
		0,48,5,0,95,2,106,6,65,82,82,65,89,0,
		106,10,80,101,110,100,105,101,110,116,101,0,106,13,
		80,97,114,99,105,97,108,109,101,110,116,101,0,106,
		10,69,110,116,114,101,103,97,100,111,0,106,6,84,
		111,100,111,115,0,4,4,0,95,1,121,72,121,72,
		...
		29,0,48,12,0,95,2,112,0,73,167,14,0,0,
