 ...
 * Generated C source from ".\.\Prg\TAcuPPed.prg"
 */
...
HB_FUNC_STATIC( TACUPPED_CREATE );
HB_FUNC_STATIC( TACUPPED_OPENFILES );
HB_FUNC_STATIC( TACUPPED_CLOSEFILES );
HB_FUNC_STATIC( TACUPPED_LRESOURCE );
HB_FUNC_STATIC( TACUPPED_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TACUPPED )
{ "TACUPPED", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPPED )}, NULL },
...
{ "TACUPPED_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPPED_CREATE )}, NULL },
{ "TACUPPED_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPPED_OPENFILES )}, NULL },
{ "TACUPPED_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPPED_CLOSEFILES )}, NULL },
{ "TACUPPED_LRESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPPED_LRESOURCE )}, NULL },
{ "TACUPPED_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPPED_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TACUPPED, ".\\.\\Prg\\TAcuPPed.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TACUPPED
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TACUPPED )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( TACUPPED )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,106,9,84,65,99,117,80,80,101,100,0,108,4,
...
HB_FUNC_STATIC( TACUPPED_LGENERATE )
{
	static const HB_BYTE pcode[] =
	{
		...
		112,1,73,36,131,0,106,19,100,70,101,99,80,101,
