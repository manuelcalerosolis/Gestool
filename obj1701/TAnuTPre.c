 ...
 * Generated C source from ".\.\Prg\TAnuTPre.prg"
 */
...
HB_FUNC_STATIC( TANUTPRE_CREATE );
HB_FUNC_STATIC( TANUTPRE_OPENFILES );
HB_FUNC_STATIC( TANUTPRE_CLOSEFILES );
HB_FUNC_STATIC( TANUTPRE_LRESOURCE );
HB_FUNC_STATIC( TANUTPRE_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TANUTPRE )
{ "TANUTPRE", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( TANUTPRE )}, NULL },
...
{ "TANUTPRE_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TANUTPRE_CREATE )}, NULL },
{ "TANUTPRE_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TANUTPRE_OPENFILES )}, NULL },
{ "TANUTPRE_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TANUTPRE_CLOSEFILES )}, NULL },
{ "TANUTPRE_LRESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TANUTPRE_LRESOURCE )}, NULL },
{ "TANUTPRE_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TANUTPRE_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TANUTPRE, ".\\.\\Prg\\TAnuTPre.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TANUTPRE
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TANUTPRE )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( TANUTPRE )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,106,9,84,65,110,117,84,80,114,101,0,108,4,
...
HB_FUNC_STATIC( TANUTPRE_LGENERATE )
{
	static const HB_BYTE pcode[] =
	{
		...
		1,112,0,106,8,100,70,101,99,80,114,101,0,112,
		1,73,36,156,0,48,80,0,48,32,0,95,1,112,
		0,106,8,110,78,117,109,80,114,101,0,112,1,73,
		36,159,0,48,78,0,48,79,0,95,1,112,0,112,
		0,122,8,28,20,36,160,0,106,9,33,108,69,115,
		116,97,100,111,0,80,3,25,50,36,161,0,48,78,
		0,48,79,0,95,1,112,0,112,0,92,2,8,28,
		19,36,162,0,106,8,108,69,115,116,97,100,111,0,
		80,3,25,13,36,164,0,106,4,46,116,46,0,80,
		3,36,167,0,176,42,0,48,81,0,48,82,0,95,
		1,112,0,112,0,12,1,31,32,36,168,0,96,3,
		0,106,8,32,46,97,110,100,46,32,0,48,81,0,
		48,82,0,95,1,112,0,112,0,72,135,36,171,0,
		...
		73,36,173,0,48,48,0,48,49,0,95,1,112,0,
		48,87,0,48,24,0,95,1,112,0,112,0,112,1,
		73,36,175,0,106,25,33,108,84,111,116,76,105,110,
		32,46,97,110,100,46,32,33,108,67,111,110,116,114,
		111,108,0,80,4,36,177,0,48,18,0,48,32,0,
		...
		32,208,0,36,196,0,48,97,0,48,68,0,95,1,
		112,0,95,2,112,1,31,97,36,197,0,48,109,0,
		48,68,0,95,1,112,0,112,0,73,36,198,0,48,
		110,0,48,68,0,95,1,112,0,95,2,112,1,73,
		36,199,0,48,111,0,48,68,0,95,1,112,0,176,
		100,0,95,2,48,68,0,48,112,0,95,1,112,0,
		112,0,106,8,99,78,111,109,84,105,112,0,12,3,
		112,1,73,36,200,0,48,113,0,48,68,0,95,1,
		112,0,112,0,73,36,203,0,48,114,0,95,1,48,
		...
		1,112,0,12,5,112,2,73,36,204,0,48,115,0,
		95,1,48,74,0,95,1,112,0,112,1,73,36,208,
		0,48,116,0,48,32,0,95,1,112,0,112,0,73,
		26,31,254,36,216,0,48,116,0,48,24,0,95,1,
		112,0,112,0,73,36,218,0,48,117,0,48,49,0,
		95,1,112,0,112,0,73,26,105,253,36,222,0,48,
		118,0,48,24,0,95,1,112,0,176,83,0,12,0,
		176,84,0,48,85,0,48,24,0,95,1,112,0,112,
		0,12,1,112,2,73,36,224,0,48,118,0,48,32,
		0,95,1,112,0,176,83,0,12,0,176,84,0,48,
		85,0,48,32,0,95,1,112,0,112,0,12,1,112,
		2,73,36,226,0,48,117,0,48,49,0,95,1,112,
		0,48,50,0,48,24,0,95,1,112,0,112,0,112,
		1,73,36,228,0,48,102,0,95,1,112,0,31,13,
		36,229,0,48,119,0,95,1,112,0,73,36,232,0,
		48,65,0,48,64,0,95,1,112,0,112,0,73,36,
		234,0,48,50,0,48,68,0,95,1,112,0,112,0,
		121,15,110,7
	};
