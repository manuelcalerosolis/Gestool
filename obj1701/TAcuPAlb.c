 ...
 * Generated C source from ".\.\Prg\TAcuPAlb.prg"
 */
...
HB_FUNC_STATIC( TACUPALB_CREATE );
HB_FUNC_STATIC( TACUPALB_OPENFILES );
HB_FUNC_STATIC( TACUPALB_CLOSEFILES );
HB_FUNC_STATIC( TACUPALB_LRESOURCE );
HB_FUNC_STATIC( TACUPALB_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_TACUPALB )
{ "TACUPALB", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPALB )}, NULL },
...
{ "TACUPALB_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPALB_CREATE )}, NULL },
{ "TACUPALB_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPALB_OPENFILES )}, NULL },
{ "TACUPALB_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPALB_CLOSEFILES )}, NULL },
{ "TACUPALB_LRESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPALB_LRESOURCE )}, NULL },
{ "TACUPALB_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( TACUPALB_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_TACUPALB, ".\\.\\Prg\\TAcuPAlb.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_TACUPALB
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_TACUPALB )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( TACUPALB )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,106,9,84,65,99,117,80,65,108,98,0,108,4,
