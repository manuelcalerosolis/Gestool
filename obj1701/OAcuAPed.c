 ...
 * Generated C source from ".\.\Prg\OAcuAPed.prg"
 */
...
HB_FUNC_STATIC( OACUAPED_CREATE );
HB_FUNC_STATIC( OACUAPED_OPENFILES );
HB_FUNC_STATIC( OACUAPED_CLOSEFILES );
HB_FUNC_STATIC( OACUAPED_LRESOURCE );
HB_FUNC_STATIC( OACUAPED_LGENERATE );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_OACUAPED )
{ "OACUAPED", {HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL}, {HB_FUNCNAME( OACUAPED )}, NULL },
...
{ "OACUAPED_CREATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUAPED_CREATE )}, NULL },
{ "OACUAPED_OPENFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUAPED_OPENFILES )}, NULL },
{ "OACUAPED_CLOSEFILES", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUAPED_CLOSEFILES )}, NULL },
{ "OACUAPED_LRESOURCE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUAPED_LRESOURCE )}, NULL },
{ "OACUAPED_LGENERATE", {HB_FS_STATIC | HB_FS_LOCAL}, {HB_FUNCNAME( OACUAPED_LGENERATE )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_OACUAPED, ".\\.\\Prg\\OAcuAPed.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_OACUAPED
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_OACUAPED )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( OACUAPED )
{
	static const HB_BYTE pcode[] =
	{
		...
		0,106,9,79,65,99,117,65,80,101,100,0,108,4,
...
HB_FUNC_STATIC( OACUAPED_LGENERATE )
{
	static const HB_BYTE pcode[] =
	{
		...
		100,0,112,1,73,36,131,0,48,63,0,48,30,0,
		95,1,112,0,106,8,110,78,117,109,80,101,100,0,
		112,1,73,36,133,0,106,19,100,70,101,99,80,101,
		...
		0,12,1,112,2,73,36,187,0,48,83,0,95,1,
		112,0,31,13,36,188,0,48,93,0,95,1,112,0,
		73,36,191,0,48,50,0,48,49,0,95,1,112,0,
		112,0,73,36,193,0,48,43,0,48,53,0,95,1,
