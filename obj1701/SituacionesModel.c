...
HB_FUNC( SITUACIONESMODEL )
{
	...
	{
		149,3,0,116,21,0,36,7,0,103,2,0,100,8,
...
HB_FUNC_STATIC( SITUACIONESMODEL_ARRAYSITUACIONES )
{
	static const HB_BYTE pcode[] =
	{
		13,2,0,36,51,0,106,20,83,69,76,69,67,84,
		32,110,111,109,98,114,101,32,70,82,79,77,32,0,
		48,17,0,102,112,0,72,80,1,36,52,0,48,18,
		0,102,95,1,112,1,80,2,36,54,0,95,2,110,
		7
	};
...
HB_FUNC_INITSTATICS()
{
	static const HB_BYTE pcode[] =
	{
		117,21,0,2,0,116,21,0,4,0,0,82,1,0,
		7
	};
