...
HB_FUNC_STATIC( MOVIMIENTOSALMACENVIEW_STARTDIALOG )
{
	static const HB_BYTE pcode[] =
	{
		...
		79,0,48,33,0,102,112,0,48,14,0,102,112,0,
		112,1,73,36,215,0,48,79,0,48,33,0,102,112,
		0,48,45,0,102,112,0,112,1,73,36,217,0,48,
		80,0,48,33,0,102,112,0,48,48,0,102,112,0,
		112,1,73,36,219,0,48,81,0,48,33,0,102,112,
